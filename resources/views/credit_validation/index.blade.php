...
<div class="our-tiles mt-5">
    <div class="container">
        <h4 class="text-capitalize text-center onmouse-6">Manage Credit limits validation</h4>
        ...
        <div class="end-button text-end">
            <div class="container mt-3 mb-3">
                <div class="text-capitalize btn btn-secondary" onclick="showAddLevelDiv()"><i
                        class="fa-solid fa-plus px-1"></i></span> Add A Validation Level</button>
                </div>
            </div>
                ...
                <div class="the-table text-capitalize ">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                <div class="units mt-2 mb-2">
                                    <p class="mt-2 mb-2  text-light">1 until <span
                                            class="dark"><strong>7.500€</strong></span></p>
                                    <div class="desc-units mt-2 mb-2">
                                        <span class="fw-bold "><img src="images/per.png" class="img-fluid" alt="">
                                            Nicolas Grayson
                                            (Collector)</span>
                                        <a href="#" class="">nicolas.durant@demosolutions.com</a>
                                    </div>
                                    <div class="delete-and-edit mt-2 mb-2 ">
                                        <div class="btn btn-secondary" onclick="showEditLevelDiv()"><span><i
                                                    class="fa-solid fa-pen"></i></span></div>
                                        <div class="btn btn-danger"><span><i class="fa-solid fa-trash"></i></span></div>
                                    </div>
                                </div>
                                <hr>
                                <div class="units mt-2 mb-2">
                                    <p class="mt-2 mb-2  text-light">2 until <span
                                            class="dark"><strong>7.500€</strong></span></p>
                                    <div class="desc-units mt-2 mb-2">
                                        <span class="fw-bold "><img src="images/per.png" class="img-fluid" alt="">
                                            Nicolas Grayson
                            ...
                            <hr>
                            <div class="units mt-2 mb-2">
                                <p class="mt-2 mb-2  text-light">3 until <span
                                        class="dark"><strong>7.500€</strong></span></p>
                                <div class="desc-units mt-2 mb-2">
                                    <span class="fw-bold "><img src="images/per.png" class="img-fluid" alt=""> Nicolas
                                        Grayson
                                        (Collector)</span>
                                    <a href="#" class="">nicolas.durant@demosolutions.com</a>
                                </div>
                        ...
                        <hr>
                        <div class="units mt-2 mb-2">
                            <p class="mt-2 mb-2  text-light">4 until <span class="dark"><strong>7.500€</strong></span>
                            </p>
                            <div class="desc-units mt-2 mb-2">
                                <span class="fw-bold "><img src="images/per.png" class="img-fluid" alt=""> Nicolas
                                    Grayson
                        ...
                        <hr>
                        <div class="units mt-2 mb-2">
                            <p class="mt-2 mb-2  text-light">5 until <span class="dark"><strong>7.500€</strong></span>
                            </p>
                            <div class="desc-units mt-2 mb-2">
                                <span class="fw-bold "><img src="images/per.png" class="img-fluid" alt=""> Nicolas
                                    Grayson
        ...
        <table class="table  px-2">
            ...
            <tbody>
                <tr class="text-center gray-colors-validations">
                    ...
                    <td>
                        <p><span><i class="fa-solid fa-check text-success"></i></span><a href="">Asimal Manager</a></p>
                    </td>
                ...
                <tr class="text-center ">
                    ...
                    <td>
                        <p><span><i class="fa-solid fa-check text-success"></i></span><a href="">Asimal Manager</a>
                    </td>
                    <td><a href="#">360108</a></td>
                    <td><a href="#">Dsmstlouis</a></td>
