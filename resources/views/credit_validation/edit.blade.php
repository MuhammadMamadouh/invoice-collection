<form action="{{route('credit-managment.update', $limitsValidation->id)}}" method="POST">
@csrf
@method("PATCH")
    <div class="overlay d-none"
        style="width: 100%;height: 100%;position: absolute;top: 0;left: 0;background-color: rgba(0, 0, 0, 0.418);z-index: 9;">
    </div>
    <div class="position-fixed add-level-div d-none" id="edit-level-div-{{$limitsValidation->id}}" style="top:10% ;left: 50%;transform: translate(-50%);z-index: 10;">
        <div class="bg-white m-auto p-3 shadow-sm position-relative" style="border-radius: 10px;">
            <span class="btn btn-secondary position-absolute" onclick="hideEditLevelDiv({{$limitsValidation->id}})"
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input type="number" name="credit_limit" value="{{old('credit_limit', $limitsValidation->credit_limit)}}" class="form-control " id="inputname18">
