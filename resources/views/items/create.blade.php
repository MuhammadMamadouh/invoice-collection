...
<!--navbar-site-->
    ...
    <section class="ring-info">
        <button
            class="btn btn-secondary my-4 px-5">{{ __('Use rather the import module to create your customers and invoices') }}</button>
    </section><!--reing-info-->
    <!--reing-info-->
            ...
            <div class="row">
                <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="my-2 col-md-6">
                        ...
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('order_date')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    </div>
                    ...
                    <div class="my-2 col-md-6">
                        ...
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('issue_date')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    </div>
                    ...
                    <div class="my-2 col-md-6">
                        ...
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('due_date')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    </div>
                    ...
                    <div class="my-2 col-md-6">
                        ...
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('po_no')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    </div>
                    ...
                    <div class="my-2 col-md-6">
                        ...
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('file_no')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    </div>
                    ...
                    <div class="my-2 col-md-6">
                        ...
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('currency_id')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    </div>
                    ...
                    <div class="my-2 col-md-6">
                        ...
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('erp_item_type')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    ...
                    <div class="my-2 col-md-6">
                        <div class="d-flex">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="Initial_amount_exc_tax"
                                    name="initial_amount_exc_tax">
                                <span class="input-group-text"><i class="fa-solid fa-euro-sign"></i></span>
                            </div>
                        </div>
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('Initial_amount_exc_tax')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    </div>
                    ...
                    <div class="my-2 col-md-6">
                        ...
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('business_case')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    </div>
                    ...
                    <div class="my-2 col-md-6">
                        <div class="d-flex">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="inputname14"
                                    name="initial_amount_inc_tax">
                                <span class="input-group-text"><i class="fa-solid fa-euro-sign"></i></span>
                            </div>
                        </div>
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('initial_amount_inc_tax')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    </div>
                    ...
                    <div class="my-2 col-md-6">
                        ...
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('sales_manager')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    </div>
                    ...
                    <div class="my-2 col-md-6">
                        <div class="d-flex">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="remaining_amount_exc_tax"
                                    name="remaining_amount_exc_tax">
                                <span class="input-group-text"><i class="fa-solid fa-euro-sign"></i></span>
                            </div>
                        </div>
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('remaining_amount_exc_tax')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    </div>
                    ...
                    <div class="my-2 col-md-6">
                        <div class="d-flex">
                            ...
                            <div class="col-7 ">
                                <input type="text" class="form-control" id="sales_administrative"
                                    name="sales_administrative">
                            </div>
                        </div>
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('sales_administrative')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    </div>
                    ...
                    <div class="my-2 col-md-6">
                        <div class="d-flex">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="remaining_amount_inc_tax"
                                    name="remaining_amount_inc_tax">
                                <span class="input-group-text"><i class="fa-solid fa-euro-sign"></i></span>
                            </div>
                        </div>
                        <div class="col-12">
                            <span class="text-danger pull-right"> @error('remaining_amount_inc_tax')
                                    {{ $message }}
                                @enderror </span>
                        </div>
                    </div>
                    ...
                    <div class="my-2 col-md-6">
                        <div class="d-flex">
                            ...
                            <div class="col-7 ">
                                <input type="text" class="form-control" id="customer_custom_field_1"
                                    name="customer_custom_field_1">
                            </div>
                        </div>
                    ...
                    <div class="my-2 col-md-6">
                        <div class="d-flex">
                            ...
                            <div class="col-7 ">
                                <input type="text" class="form-control" id="customer_custom_field_2"
                                    name="customer_custom_field_2">
                            </div>
                        </div>
