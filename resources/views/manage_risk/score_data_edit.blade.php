<form action="{{ route('manage_risk.update', $score->id) }}" method="POST">
    @csrf
    @method("PATCH")
    <div class="position-fixed new-scoring-div d-none w-75" id="new-scoring-div-{{$score->id}}"
        ...
        <div class="bg-white m-auto p-4 shadow-sm position-relative" style="border-radius: 10px;">
            <span class="btn btn-secondary position-absolute" onclick="hideEditScoringDiv({{$score->id}})"
                ...
                <form class="d-flex align-items-center">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            <input type="text" name="title" value="{{ old('title', $score->title) }}" class="form-control "
                                id="inputname18">
                        </div>
                        @error('title')
            ...
            <div class="my-2">
                ...
                <div class="col-8">
                    <input type="text" name="description" value="{{ old('description', $score->description) }}" class="form-control"
                        id="inputname28">
                </div>
                @error('description')
                    <div class="alert text-danger" style="font-weight: bold;">{{ $message }}</div>
