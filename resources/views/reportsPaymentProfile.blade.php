...
<div class="header-risk">
  <h2 class="text-capitalize text-center mt-5 mb-2">Report Payment Profile <a href="#"><i class="fa-solid fa-question bg-primary text-light p-1" style="border-radius: 50%;width: 22px;height: 22px;"></i>
  </a></h2>
</div>
<div class="title-risk text-capitalize">
  <div class="container-fluid d-lg-flex justify-content-between">
    <div>
      <button class="mt-1 text-capitalize border-primary"><span><i class="fa-solid fa-chart-pie pe-2"></i></span> sales history</button>
      <a href="reportsPaymentProfileTrend.html" class="mt-1 text-decoration-none ms-2 text-capitalize text-primary border-0"><span><i class="fa-solid fa-chart-simple pe-2"></i></span> Trend</a>
    </div>
          ...
          <div class="col-lg-8">
            <div class="d-flex justify-content-center gap-3 mb-3">
              ...
              <div>
                ...
                <div class="chart-2">
                  <canvas id="myChart-4"  width="350" height="350"></canvas>
                </div>
                <div class="mt-3 text-center">
                  <div class="d-inline-flex">Average time of payment : <div class="fw-bold"> 43 day</div></div>
                  <br>
                  <div class="d-inline-flex">Average days beyond terms : <div class="fw-bold"> 6 days</div></div>
              </div>
          </div>
          <div class="col-lg-4">
  ...
  <div class="container-fluid">
    <div>
      ...
      <div
        ...
        <div class="row align-items-center pt-3" style="background-color: #006bff14" >
          <div class="col-1 mb-3 hide position-relative">
          ...
          <div class="col-3 col-md-2"><p class="fw-bold">1230504</p></div>
          <div class="col-3 col-md-2"><p class="fw-bold"><a href="#" onclick="showHolap()">Kokel</a></p></div>
          <div class="col-3 col-md-1">
            <p class="fw-bold">389d</p>
          </div>
          <div class="col-2 hide">
            <p class="fw-bold">318d</p>
          </div>
          <div class="col-2 hide">
        ...
        <div class="row align-items-center pt-3">
          ...
          <div class="hidden ms-2 d-none">
            <div class="d-flex">
              <p class="fw-bold">Flag:</p>
              <span class="onmouse-2"><i class="fa-solid fa-flag text-warning"></i></span>
              <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span>
              </p>
            </div>
            <div class="d-flex">
        ...
        <div class="row align-items-center pt-3" style="background-color: #006bff14" >
          <div class="col-1 mb-3 hide position-relative">
            <span class="onmouse-2"><i class="fa-solid fa-flag text-white" style="font-size: 25px;"></i></span>
            <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span>
          </div>
          <div class="col-3 col-md-2"><p class="fw-bold">1230504</p></div>
          <div class="col-3 col-md-2"><p class="fw-bold"><a href="#" onclick="showHolap()">Kokel</a></p></div>
          ...
          <div class="hidden ms-2 d-none">
            <div class="d-flex">
              <p class="fw-bold">Flag:</p>
              <span class="onmouse-2"><i class="fa-solid fa-flag text-white"></i></span>
              <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span>
              </p>
            </div>
            <div class="d-flex">
        ...
        <div class="row align-items-center pt-3">
          ...
          <div class="hidden ms-2 d-none">
            <div class="d-flex">
              <p class="fw-bold">Flag:</p>
              <span class="onmouse-2"><i class="fa-solid fa-flag text-info"></i></span>
              <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span>
              </p>
            </div>
            <div class="d-flex">
        ...
        <div class="row align-items-center pt-3" style="background-color: #006bff14" >
          ...
          <div class="hidden ms-2 d-none">
            <div class="d-flex">
              <p class="fw-bold">Flag:</p>
              <span class="onmouse-2"><i class="fa-solid fa-flag text-dark"></i></span>
              <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span>
              </p>
            </div>
            <div class="d-flex">
      ...
      <div class="row text-center mb-3">
        ...
        <div class="col-3 col-md-1 hide"></div>
        <div class="col-3 col-md-2">Total :34 days</div>
        <div class="col-3 col-md-2">6 days</div>
      <div class="col-3 col-md-2">6.6 M€</div>
      <div class="col-3 col-md-2">1.7 k€</div>
    </div>
  </div>
