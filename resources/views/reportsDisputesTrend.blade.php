...
<div class="header-risk ">
  <h2 class="text-capitalize text-center mt-5 mb-2 ">Report Disputes  <a href="#"><i class="fa-solid fa-question bg-primary text-light p-1" style="border-radius: 50%;width: 22px;height: 22px;"></i></a></h2>
</div>
<div class="title-risk text-capitalize">
  <div class="container-fluid d-flex justify-content-between">
    <div class="d-flex">
      <button class="mt-1 text-capitalize border-0" style="cursor: pointer;"><a href="reportsDisputes.html" class="text-decoration-none"><span><i class="fa-solid fa-pie-chart pe-2"></i></span>Current situation </a></button>
      <button class="mt-1 px-2 text-capitalize border-primary " style="cursor: pointer;"><a href="#" class="text-decoration-none"><span><i class="fa-solid fa-signal pe-2"></i></span>Trend </a></button>
      <button class="mt-1 text-capitalize border-0" style="cursor: pointer;"><a href="reportsDisputesResolution.html" class="text-decoration-none"><span><i class="fa-regular fa-square-check pe-2"></i></span>Resolution </a></button>
    </div>
</div>
...
<div class="risk-1">
  <div class="container-fluid">
      <div class="row p-2">
          <div class="col-lg-8">
            <div class="weeaks d-flex justify-content-between mb-3 text-capitalize">
                <div>
                  <span class="mb-5">by : </span>
                  <input type="radio" id="weak" name="checkbox">
                  <label for="weak">weak</label>
                  <input type="radio" id="month" name="checkbox">
                  <label for="month">month</label>
                </div>
                <div>
                  <input type="radio" id="Number" name="num">
                  <label for="Number">Number</label>
                  <input type="radio" id="Amount" name="num">
            ...
            <div class="d-flex justify-content-end">
              <i class="fa-solid fa-download text-secondary " style="font-size: 25px;"></i>
            </div>
                <div class="chart-2">
                  <canvas id="myChart-13"  width="700" height="400"></canvas>
                </div>
          </div>
          <div class="col-lg-4">
            <div class="dispute-type text-capitalize ">
              <h6 class="fw-bold">Type of dispute<a href="settings-manage-item-status.html" target="_blank"><i class="fa-regular fa-share-from-square"></i></a></h6>
              <div class="not-empty d-flex align-items-center margin-ten-px">
                <input type="radio" name="inputs-raidos" id="all" class="margin-ten-px">
                <label for="all">[ All ]</label>
             
              </div>
              <div class="litige-administratif-checks d-flex align-items-center margin-ten-px">
                <input type="radio" name="inputs-raidos" id="administratif" class="margin-ten-px">
                <label for="administratif" >Litige administratif</label>
               <span class="margin-ten-px"></span>
              </div>
          
              <div class="litige-livraison-checks d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-raidos" id="livraison" class="margin-ten-px">
                <label for="livraison">Litige livraison</label>
               <span class="margin-ten-px"></span>
              </div>
              <div class="litige-matériel-manquant-checks d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-raidos" id="manquant" class="margin-ten-px">
                <label for="manquant">Litige matériel manquant</label>
               <span class="margin-ten-px"></span>
              </div>
              <div class=" litige-prix-checks d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-raidos" id="prix" class="margin-ten-px">
                <label for="prix"> Litige prix</label>
               <span class="margin-ten-px" ></span>
              </div>
              <div class="litige-qualité-checks d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-raidos" id="qualité" class="margin-ten-px">
                <label for="qualité">Litige qualité</label>
               <span class="margin-ten-px"></span>
              </div>
              <div class=" missing-po-checks d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-raidos" id="PO" class="margin-ten-px">
                <label for="PO">Missing PO</label>
               <span class="margin-ten-px"></span>
              </div>
              <div class=" price-dispute-checks d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-raidos" id="Dispute" class="margin-ten-px">
                <label for="Dispute">Price Dispute</label>
               <span class="margin-ten-px"></span>
              </div>
            </div>
              <div class="rikss-input">
                <div class="form-group">
                  <select class="form-select border-primary m-2" onfocus='this.size=9;' onblur='this.size=1;' onchange='this.size=1; this.blur();' aria-label=" Default select example">
                ...
                <div class="form-group">
                  <select class="form-select border-primary m-2 w-100" aria-label="Default select example">
                ...
                <div class="form-group">
                  <select class="form-select border-primary m-2" aria-label="Default select example">
                ...
                <div class="form-group ">
                  <select class="form-select border-primary m-2" aria-label="Default select example">
                    <option value="" selected disabled>Custom Field #1 :</option>
              ...
              <div class="the-add mb-3">
                  <div class="add text-center">
                    <h6>Gropus Reuslts By</h6>
                    <div class="input-add">
                      <div class="form-group ">
                        <select class="form-select border-primary m-2" aria-label="Default select example">
                          <option value="0" selected>Company / bussiness name</option>
                          <option value="1">Collector</option>
                          <option value="2">Customers Custom Field #1</option>
                          <option value="3">Customers Custom Field #2</option>
                        </select>
                      </div>
                  </div>
                  </div>
...
<div class="texts text-capitalize">
  <div class="container-fluid">
    <div class="responive-report-5">
      ...
      <div class="row mt-2 px-4 align-items-center text-center">
        <div class="col">
          <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">Qualified amount 05-13 -> Today</p>
          </div>
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">week 19 <br> 05-06 -> 05-12</p>
          </div>
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">week 18 <br> 04-29 -> 05-05</p>
          </div>
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">week 17 <br> 04-22 -> 04-28</p>
          </div>
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">week 16 <br> 04-15 -> 04-21</p>
          </div>
      ...
      <div
        class="text-center mb-3 p-2 p-md-4">
        ...
        <div class="row align-items-center pt-3" style="background-color: #006bff14" >
          ...
          <div class="col "><p class="fw-bold">1230504</p></div>
          <div class="col "><p class="fw-bold"><a href="#" onclick="showHolap()">Kokel</a></p></div>
          <div class="col hide">
            <p class="fw-bold">393 k€</p>
          </div>
          <div class="col hide">
            <p class="fw-bold">393 k€</p>
          </div>
      ...
      <div class="row text-center mb-3">
        <div class="col-md-1 col-4  mb-3 hide"></div>
        <div class="col-md-1 col-4  hide"></div>
        <div class="col-md-1 col-4  hide"></div>
        <div class="col-md-1 col-4  hide"></div>
        <div class="col-md-1 col-4 ">Total :393 k€</div>
        <div class="col-md-1 col-4 ">393 k€</div>
      <div class="col-md-1 col-4 ">393 k€</div>
      <div class="col-md-1 col-4 ">393 k€</div>
        <div class="col-md-1 col-4 ">393 k€</div>
      <div class="col-md-1 col-4 ">393 k€</div>
...
<!--texts-->
   ...
   <script src="js/chart-13.js"></script>
