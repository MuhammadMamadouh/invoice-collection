...
<body class="cairo-uniquifier position-relative">
  ...
  <div class="position-fixed create-group-div d-none" style="top:10% ;left: 50%;transform: translate(-50%);z-index: 10;">
    <div class="bg-white m-auto p-3 shadow-sm position-relative" style="border-radius: 10px;">
      ...
      <div class="my-2">
        <h3 class="text-center mb-3">Create a group</h3>
        <form class="d-flex align-items-center mb-3">
          <div class="col-2 ">
            <label for="inputname18"> Name:</label>
          </div>
          <div class="col-10">
          ...
          <div class="d-flex gap-3">
            ...
            <div>
              <label>Associated with the group :</label>
              <textarea class="form-control" cols="30" rows="10"></textarea>
            </div>
          </div>
      </div><!--24-->
    ...
    <div class="navbar-all-site cairo-uniquifier">
      <div class="top-navbar ">
       <div class="container">
           ...
           <a href="settings.html"><img src="{{asset('img/person2.jpg')}}" class="img-fluid" alt=""></a>
      ...
      <div class="groups-t position-relative ">
        <table class="table table-striped rounded">
          ...
          <tr class="kall">
            ...
            <td class="border-0">
              <p class="operate name-d ">
                <a href="#" onclick="showEditGroupDiv()" class="text-decoration-none edite-groups rounded"><i class="fa-solid fa-pen"></i></a>
                <a href="#" class="text-decoration-none delete-groups rounded"><i
