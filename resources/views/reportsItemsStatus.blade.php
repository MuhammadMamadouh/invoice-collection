...
<div class="header-risk">
  <h2 class="text-capitalize text-center mt-5 mb-2">Report Items status  
    <a href="reportsItemsStatusInformation.html"><i class="fa-solid fa-question bg-primary text-light p-1" style="border-radius: 50%;width: 22px;height: 22px;"></i>
    </a></h2>
</div>
<div class="title-risk text-capitalize">
  <div class="container-fluid d-flex justify-content-between">
    <div class="d-flex">
      <button class="mt-1 text-capitalize border-primary" style="cursor: pointer;"><a href="#" class="text-decoration-none"><span><i class="fa-solid fa-pie-chart pe-2"></i></span>Current situation </a></button>
      <button class="mt-1 text-capitalize border-0" style="cursor: pointer;"><a href="reportsItemsStatusTrend.html" class="text-decoration-none"><span><i class="fa-solid fa-signal pe-2"></i></span>Trend </a></button>
    </div>
</div>
  ...
  <div class="container-fluid">
      <div class="row p-2 ">
          <div class="col-lg-8">
            ...
            <div class="chart-dis d-flex justify-content-end">
              <i class="fa-solid fa-download text-secondary " style="font-size: 25px;"></i>
            </div>
                <div class="chart-2">
                  <canvas id="myChart-11"  width="700" height="400"></canvas>
                </div>
          ...
          <div class="col-lg-4 ">
            <div class="type-of-stuts  text-capitalize ">
              ...
              <div class="not-empty d-flex align-items-center">
                <input type="radio" name="inputs-group" id="empty">
                <label for="empty">[ Not empty ]</label>
               <span>727 k€</span>
              </div>
              <div class="not-empty d-flex align-items-center">
                <input type="radio" name="inputs-group" id="none">
                <label for="none">[ none ]</label>
               <span>4,274 k€</span>
              </div>
              <div class="green-checks d-flex align-items-center">
                <input type="radio" name="inputs-group" id="Dispute">
                <label for="Dispute">Dispute</label>
               <span>96 k€</span>
              </div>
              <div class="resolved-checks flex align-items-center">
                <input type="radio" name="inputs-group" id="resolved">
                <label for="resolved">Dispute resolved </label>
               <span>23.8 k€</span>
              </div>
              <div class="yellows-checks d-flex align-items-center">
                <input type="radio" name="inputs-group" id="Litigation">
                <label for="Litigation"> Litigation</label>
               <span>29.2 k€</span>
              </div>
              <div class="ongoing-checks d-flex align-items-center">
                <input type="radio" name="inputs-group" id="going">
                <label for="going">On going</label>
               <span> 212 k€</span>
              </div>
              <div class="promise-checks d-flex align-items-center">
                <input type="radio" name="inputs-group" id="Promise">
    ...
    <div class="responive-report-5">
      ...
      <div class="row mt-2 px-4 align-items-center text-center">
        ...
        <div class="col hide">
                    ...
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">Qualified amount</p>
          </div>
        ...
        <div class="col hide">
                    ...
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">%Qualified overdue</p>
          </div>
