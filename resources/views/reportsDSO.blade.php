    ...
    <div class="container">
      <div class="row pb-3">
        <div class="col-lg-6" style="height:300px ;">
          ...
          <canvas id="myChart-80"  width="200" height="200"></canvas>
        </div>
        <div class="col-lg-6" style="height:300px ;">
...
<!--new-Holap-->
  ...
  <div class="header-risk">
    <h2 class="text-capitalize text-center mt-5 mb-2">Report DSO <a href="DSOInformation.html"><i
          class="fa-solid fa-question bg-primary text-light p-1"
          style="border-radius: 50%;width: 22px;height: 22px;"></i></a></h2>
  </div>
  <div class="title-risk text-capitalize">
    <div class="container-fluid d-flex justify-content-between">
      <div>
        <button class="mt-1 text-capitalize border-primary"><span><i class="fa-solid fa-chart-line me-2"></i></span>DSO
          trend </button>
      </div>
    </div>
    ...
    <div class="container-fluid">
      <div class="row p-2 ">
        <div class="col-lg-8">
          ...
          <div class="chart-2">
            <canvas id="myChart-8" width="700" height="400"></canvas>
          </div>
        </div>
        <div class="col-lg-4">
