  ...
  <div class="company-details d-none">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="d-flex justify-content-end gap-3 w-25">
            <div class="icon-holab  ">
              <i class="fa-solid fa-pen text-primary p-2 bg-light" onclick="EditHolap()"
                style="  font-size: 15px; cursor: pointer; border-radius: 5px;"></i>
              <a href="holapDetails.html" target="_blank"><i class="fa-solid fa-maximize text-primary p-2 bg-light"
                  style="  font-size: 15px; cursor: pointer; border-radius: 5px;"></i></a>
              <i class="fa-solid fa-close text-light p-2 bg-danger" onclick="closeHolap()"
                style="  font-size: 15px; cursor: pointer; border-radius: 5px;"></i>
            </div>
          </div>
        </div>
    ...
    <div class="create-c-i holap-second bg-light d-none">
      <div class="d-flex gap-3 justify-content-end text-center m-0 mb-3 p-3 w-100" style="background-color: #006bff">
        ...
        <span class="btn px-4 text-light p-1 btn-success" onclick="closeEditHolap()"><i class="fa-solid fa-floppy-disk"
            style="  font-size: 15px;"></i> Save</span>
        <span class="btn px-4 text-light p-1 btn-warning" onclick="closeEditHolap()"><i class="fa-solid fa-reply"
      ...
      <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
          ...
          <span class="navbar-toggler-icon">
            <span class="text-light"><i class="fa-solid fa-bars p"></i></span>
          </span>
        </button>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto text-center mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="globalView.html"><span><i
  ...
  <div class="new-holap d-none " id="hide-hoalp">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="max-mize">
          <a href="email-preview.html" target="_blank" style="border-radius: 50%;" class="btn btn-primary text-end"><i class="fa-solid fa-maximize"></i></a>
        </div>
      <h2 class="text-capitalize text-center mt-3 mb-3">Email preview</h2>
      <button class="close-hollab btn btn-danger" onclick="show_popup()" id="popup"><span><i class="fa-solid fa-close"></i></span></button>
      <div class="emil-para">
      ...
      <div class="email-prev">
        ...
        <div class="view-button mt-3 mb-3">
          <a href="account-statement.html" class="btn btn-success"><span><i class="fa-solid fa-comments"></i></span> View my account
            statement</a>
        </div>
        <div class="descri">
        ...
        <div class="client-code">
          ...
          <div class="client-codes d-flex justify-content-between align-items-center">
            <p><span><i class="fa-solid fa-star"></i></span> Click the Trans No. for more information and write a comment:</p>
            <div class="this-buttons">
            <button type="button" class="btn text-light"><span><i class="fa-solid fa-download"></i>&ensp;</span>Export this data to excel</button>
              </div>
            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="text-center">
                            <tr>
                                ...
                                <td style="display: flex;"><img src="img/pdficons.gif" style="width: 17px;" alt="" class="img-fluid" alt=""><a href=""> 414472</a></td>
                                <td>Eros Proin Ultrices Foundation (B)</td>
                                <td>2024-04-05</td>
                                <td>2024-04-05</td>
                                <td>77 d</td>
                                <td>7,112.64 €	</td>
                                <td style="display: flex; justify-content: space-between;">7,112.64 € <img src="img/card.png" style="width: 17px;" alt="" class="img-fluid" alt=""></td>
                                <td></td>
                            </tr>
                            <tr>
                    ...
                    <table class="table table-bordered">
                        <tbody class="text-center">
                            <tr>
                                ...
                                <td style="display: flex; "><img src="img/pdficons.gif" style="width: 17px;" alt="" class="img-fluid" alt=""><a href="">_</a></td>
                                <td>Eros Proin Ultrices Foundation (B)</td>
                                <td>2024-04-05</td>
                                <td>2024-04-05</td>
                                <td>77 d</td>
        ...
        <section class="mt-5">
          <div class="container-fluid ">
            <div class="row">
              ...
              <div class="col-lg-3 col-md-4 col-sm-6">
                <a href="collection.html" class="m-1 w-100 btn btn-primary text-light p-3"><i
              ...
              <!--btns-->
              <div class="col-lg-3 col-md-4 col-sm-6">
                <a href="collectionActionsHistoy.html" class="m-1 w-100 btn btn-outline-primary p-3"><i
                    class="fa-solid fa-bars-staggered"></i>
                  Actions history</a>
              </div>
              <div class="col-lg-3 col-md-4 col-sm-6">
                <a href="collectionAlerts.html" class="m-1 w-100 btn btn-outline-primary p-3"><i
            ...
            <div>
              <form class="row justify-content-center">
                <div class="col-lg-1 col-md-2 col-sm-3 dropdown">
                  <a class="dropdown-toggle text-primary form-control m-2" href="#" id="reportsDropdown" role="button"
                    data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="fa-solid fa-signal"></i>
                  </a>
                  <ul class="dropdown-menu" aria-labelledby="reportsDropdown">
                    <li><a class="dropdown-item text-primary" href="#" onclick="showCharts1()"><i
                          class="fa-solid fa-hand-point-right"></i>Actions to do</a></li>
                    <li><a class="dropdown-item text-primary" href="#" onclick="showCharts2()"><i
                          class="fa-solid fa-thumbs-up"></i> Actions done</a>
                    </li>
                    <li><a class="dropdown-item text-primary" href="#" onclick="showCharts3()"><i
            ...
            <div class="row p-3 bg-light d-none collection-charts-1">
              <div class="col-lg-3">
                <h6><i class="fa-solid fa-hand-point-right me-2"></i>Actions to do</a></h6>
                <div class="my-3">
                ...
                <ul class="list-unstyled text-secondary">
                  <li class="d-flex flex-wrap gap-2">
                    <div class="mt-1" style="width:15px ;height:15px;background-color:#4A67FF;"></div> @ E-mail : <span
                      class="fw-bold">442</span>
                  </li>
                  <li class="d-flex flex-wrap gap-2">
                    <div class="mt-1" style="width:15px ;height:15px;background-color:#0021CF;"></div> @ E-mail (Automatic
                    action) : <span class="fw-bold">442</span>
                  </li>
                  <li class="d-flex flex-wrap gap-2">
                    <div class="mt-1" style="width:15px ;height:15px;background-color:#C77A07;"></div> <i
                      class="fa-solid fa-phone mt-1"></i> Phone : <span class="fw-bold">442</span>
                  </li>
                  <li class="d-flex flex-wrap gap-2">
                    <div class="mt-1" style="width:15px ;height:15px;background-color:#007397;"></div> <i
                      class="fa-solid fa-envelope mt-1"></i> SMS : <span class="fw-bold">442</span>
                  </li>
                  <li class="d-flex flex-wrap gap-2">
                    <div class="mt-1" style="width:15px ;height:15px;background-color:#CE000C;"></div> <i
                      class="fa-solid fa-mobile mt-1"></i> Dunning letters : <span class="fw-bold">442</span>
                  </li>
                </ul>
              </div>
              <div class="col-lg-9 bg-white" style="height:400px ;">
                <canvas id="myChart-10" width="700" height="400"></canvas>
              </div>
      
            </div>
            <div class="row p-3 bg-light d-none collection-charts-2">
              <div class="col-lg-3">
                <h6><i class="fa-solid fa-hand-point-right me-2"></i>Action Done</a></h6>
                <div class="my-3">
                  <span class="mb-5">By : </span>
                ...
                <ul class="list-unstyled text-secondary">
                  ...
                  <li class="d-flex flex-wrap gap-2">
                    <div class="mt-1" style="width:15px ;height:15px;background-color:#CE000C;"></div> <i
                      class="fa-solid fa-mobile mt-1"></i> Dunning letters via ERM : <span class="fw-bold">442</span>
                  </li>
                  <li class="d-flex flex-wrap gap-2">
                    <div class="mt-1" style="width:15px ;height:15px;background-color:#FF0081;"></div> Litigation : <span class="fw-bold">442</span>
                  </li>
                </ul>
              ...
              <div class="col-lg-9 bg-white" style="height:400px ;">
                <canvas id="myChart-101" width="700" height="400"></canvas>
              </div>
      
            </div>
            <div class="row p-3 bg-light d-none collection-charts-3">
              <div class="col-lg-3">
                <h6><i class="fa-solid fa-clock me-2"></i> Actions forecast</a></h6>
                <div class="my-3">
                  <span class="mb-5">By : </span>
                ...
                <ul class="list-unstyled text-secondary">
                  ...
                  <li class="d-flex flex-wrap gap-2">
                    <div class="mt-1" style="width:15px ;height:15px;background-color:#007397;"></div> <i
                      class="fa-solid fa-envelope mt-1"></i>Email (Automatic action) : <span class="fw-bold">442</span>
                  </li>
                  <li class="d-flex flex-wrap gap-2">
                    <div class="mt-1" style="width:15px ;height:15px;background-color:#C77A07;"></div> <i
                      class="fa-solid fa-phone mt-1"></i> Phone : <span class="fw-bold">442</span>
              ...
              <div class="col-lg-9 bg-white" style="height:400px ;">
                <canvas id="myChart-102" width="700" height="400"></canvas>
              </div>
          ...
          <div class="container-fluid">
            ...
            <div class="text-center mb-3 table-container p-2 p-md-4">
              <div class="row align-items-center pt-3" style="background-color: #006bff14">
                ...
                <div class="col-md-2 col-5">
                  <div class="btn show-new-holap text-light text-decoration-none btn-primary w-100 mb-3">
                    @ E-mail
                  </div>
                </div>
                <div class="col-2 hide">
                  <p><a href="#" class="show-new-holap">Relance par email n°1</a></p>
                </div>
                <div class="col-2 hide">
                  <p>12,916.00 €</p>
                </div>
                <div class="col-1 hide">
                  <span class="onmouse-2"><i class="fa-solid fa-flag mb-2 text-primary"></i></span>
                ...
                <div class="col">
                  <p class="fw-bold"><a href="#" onclick="showHolap()">Kokel</a></p>
                </div>
                <div class="col tavle-dropdown-icon" onclick="toggleFunction(this)">
                  <i class="fa-solid fa-chevron-down"></i>
                </div>
                <div class="hidden ms-2 d-none">
                  <div class="d-flex bg-white">
                    <p class="fw-bold">Action:</p>
                    <p class="show-new-holap">Relance par email n°1</p>
                  </div>
                  <div class="d-flex bg-white">
                    <p class="fw-bold">Action amount:</p>
                    <p>12,916.00 €</p>
              ...
              <div class="row align-items-center pt-3">
                ...
                <div class="col-1 hide">
                  <span class="onmouse-2"><i class="fa-solid fa-flag mb-2 text-danger"></i></span>
                  <span class="conttt-2">payment profile < payeur correct / average payeur> <br> average days beyond
                      items
                      +28days (< 10days) </span>
                </div>
              ...
              <div class="row align-items-center pt-3" style="background-color: #006bff14">
                ...
                <div class="col-1 hide">
                  <span class="onmouse-2"><i class="fa-solid fa-flag mb-2 text-success"></i></span>
                  <span class="conttt-2">payment profile < payeur correct / average payeur> <br> average days beyond
                      items
                      +28days (< 10days) </span>
                </div>
              ...
              <div class="row align-items-center pt-3" style="background-color: #006bff14">
                ...
                <div class="col-1 hide">
                  <span class="onmouse-2"><i class="fa-solid fa-flag mb-2 text-white"></i></span>
                  <span class="conttt-2">payment profile < payeur correct / average payeur> <br> average days beyond
                      items
                      +28days (< 10days) </span>
                </div>
                ...
                <div class="hidden ms-2 d-none">
                  ...
                  <div class="d-flex bg-white">
                    <p class="fw-bold">Flag:</p>
                    <!--flAG-FIVE-->
                    <span class="onmouse-2"><i class="fa-solid fa-flag mb-2 text-light"></i></span>
                    <span class="conttt-2">payment profile < payeur correct / average payeur> <br> average days beyond
                        items
                        +28days (< 10days) </span>
                  </div>
              ...
              <div class="row align-items-center pt-3">
                ...
                <div class="col-1 hide">
                  <span class="onmouse-2"><i class="fa-solid fa-flag mb-2 text-dark"></i></span>
                  <span class="conttt-2">payment profile < payeur correct / average payeur> <br> average days beyond
                      items
                      +28days (< 10days) </span>
                </div>
              ...
              <div class="row align-items-center pt-3" style="background-color: #006bff14">
                ...
                <div class="col-1 hide">
                  <span class="onmouse-2"><i class="fa-solid fa-flag mb-2 text-warning"></i></span>
                  <span class="conttt-2">payment profile < payeur correct / average payeur> <br> average days beyond
                      items
                      +28days (< 10days) </span>
                </div>
              ...
              <div class="row align-items-center pt-3">
                ...
                <div class="col-1 hide">
                  <span class="onmouse-2"><i class="fa-solid fa-flag mb-2 text-info"></i></span>
                  <span class="conttt-2">payment profile < payeur correct / average payeur> <br> average days beyond
                      items
                      +28days (< 10days) </span>
                </div>
            ...
            <div class="text-md-start mx-md-5 text-center px-4 mb-2">
              <div class=" thebtn-3 btn  btn-primary text-light px-2 m-1">
                <i class=" fa-solid fa-check"></i>&ensp; Confirm the automatic action
              </div>
        ...
        <script src="./js/chart-101.js"></script>
        <script src="./js/chart-102.js"></script>
        <script src="./js/chart-60.js"></script>
        <script src="./js/chart-80.js"></script>
