      ...
      <div class="texts text-capitalize ">
        <div class="container-fluid">
          ...
          <form class="row col-lg-9 d-none justify-content-center toggle-row">
            ...
            <div class="form-group col-md-4 col-sm-6">
              <select class="form-select m-2 w-100" aria-label="Default select example">
                <option selected disabled>Payment profile :</option>
                <option value="1">Très Bon Payeur / Very Good Payer</option>
                <option value="2">Bon Payeur / Good Payer</option>
                <option value="3"> Payeur Correct / Average Payer</option>
                <option value="3">Mauvais Payeur / Bad Payer</option>
                <option value="3">Très Mauvais Payeur / Very Bad Payer</option>
                <option value="3">Retards Inadmissibles / Unacceptable Delays</option>
                <option value="3">[None]</option>
              </select>
            </div>
          </form>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
          <div class="form-group d-flex align-items-center">
            ...
            <div class="big-table">
              <div class="big-table-child" style="width: 4500px; ">
              <div class="row mt-2 p-2 px-md-4 text-center align-items-center">
                  <div class="col ">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                    <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                    <p class="fw-bold">legal ID</p>
                  ...
                  <div class="col ">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                    <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                    <p class="fw-bold">Order backlog</p>
                  </div>
                  </div>
                  <div class="col ">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                  ...
                  <div class="col ">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                    <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                    <p class="fw-bold">Guarantee world insuer</p>
                  </div>
                  </div>
                  <div class="col ">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                  ...
                  <div class="col ">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                    <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                    <p class="fw-bold">Credit <br> avaliable</p>
                  </div>
                  </div>
                  <div class="col ">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                    <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                    <p class="fw-bold">Score <br> <span class="text-black-50">World Insurer</span></p>
                  </div>
                  </div>
                  <div class="col ">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                    <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                    <p class="fw-bold"> <img src="./img/ellisphere_48x48.png" style="width:25px ;" class="img-fluid me-1" alt="">Score</p>
                  </div>
                  </div>
                  <div class="col ">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                    <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                    <p class="fw-bold"> <img src="./img/ellisphere_48x48.png" style="width:25px ;" class="img-fluid me-1" alt="">Risk Class</p>
                  </div>
                  </div>
                  <div class="col ">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                    <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                    <p class="fw-bold"> <img src="./img/ellisphere_48x48.png" style="width:25px ;" class="img-fluid me-1" alt="">Recommended Credit</p>
                  </div>
                  </div>
                  <div class="col ">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                    <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                    <p class="fw-bold"> <img src="./img/ellisphere_48x48.png" style="width:25px ;" class="img-fluid me-1" alt="">PayPank</p>
                  </div>
                  </div>
                  <div class="col ">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                    <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                    <p class="fw-bold"> <img src="./img/ellisphere_48x48.png" style="width:25px ;" class="img-fluid me-1" alt="">Payment Deedline</p>
                  </div>
                  </div>
                  <div class="col ">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                    <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                    <p class="fw-bold"> <img src="./img/ellisphere_48x48.png" style="width:25px ;" class="img-fluid me-1" alt="">Legal Proceeding</p>
                  </div>
                  </div>
              </div>
              <div
                class="text-center mb-3 p-2 px-md-4">
                <div class="row align-items-center pt-3" style="background-color: #006bff14" >
                  <div class="col "><p class="fw-bold">1230504</p></div>
                    <div class="col position-relative">
                                      <span class="onmouse-2"><i class="fa-solid fa-flag text-primary mb-3" style="font-size: 12px;"></i></span>
              ...
              <div class="row">
                ...
                <div class="col"></div>
                <div class="col"></div>
                <div class="col"><p class="fw-bold">Total :37.9 M€</p></div>
                <div class="col"><p class="fw-bold">31.2 M€</p></div>
                <div class="col"><p class="fw-bold">6.6 M€</p></div>
                <div class="col"><p class="fw-bold">1.7 M€</p></div>
                <div class="col"><p class="fw-bold">39%</p></div>
                <div class="col"><p class="fw-bold">1.7 M€</p></div>
                <div class="col"><p class="fw-bold">31.2 M€</p></div>
                <div class="col"><p class="fw-bold">6.6 M€</p></div>
                <div class="col"><p class="fw-bold">1.7 M€</p></div>
