<div>
    <form>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div style=" display: flex; flex-wrap: wrap;" class="my-2">
                                        <p> <input type="checkbox" wire:model="get_a_copy"
                                ...
                                <div class="col-md-10 mt-2">
                                    ...
                                    <div style=" display: flex; flex-wrap: wrap;" class="my-2">
                                        <a href="#" class="text-primary mx-3"
                                            style="text-decoration: none;"><span class="mx-1"><i
                                                    class="fa-solid fa-plus text-dark"></i></span>Add
                                            another
                                            recipient</a>
                                        <a href="#" class="text-primary mx-3"
                                            style="text-decoration: none;"><span class="mx-1"><i
                                                    class="fa-solid fa-plus text-dark"></i></span>Add an
                                            external
                                            recipient</a>
                                    </div>
                                </div><!--r-2-->
        ...
        <div class="d-flex justify-content-end my-5">
            <div class="btn btn-danger px-5 mx-5"><i class="fa-solid fa-chevron-left pe-2"></i> Previus</div>
            <button  class="btn btn-primary px-5 mx-5">{{ __('Next') }} <i
