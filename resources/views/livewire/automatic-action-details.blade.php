                    ...
                    <div class="row mt-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 mt-2">
                                <p>{{ $colletorFirstName }} {{ $colletorLastName }} {{ $colletorEmail }} (Role:
                                    {{ $colletorRole }})</p>
                            </div><!--r-2-->
                        </div><!--end-row-->
                        <div class="col-md-2 mt-2">
                        ...
                        <div class="col-md-10 mt-2">
                            <p class="form-control" id="">{{ $subject }}</p>
                        </div><!--r-3-->
                        <div class="col-md-2 mt-2">
                        ...
                        <div class="col-md-10 mt-2">
                            <div class="mb-1">
                                <p id="editor" class="form-control">{{ $editorContent }}</p>
                            </div>
                        </div><!--r-4-->
                        ...
                        <div class="text-center mb-3 table-container-2 p-2 px-md-4  ">
                            <div class="row align-items-center pt-3"
                                ...
                                <div class="col">
                                    <p class="fw-bold"><a href='#' style="text-decoration: none !important;"><img
