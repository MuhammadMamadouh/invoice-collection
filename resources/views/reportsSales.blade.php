...
<div class="header-risk">
  <h2 class="text-capitalize text-center mt-5 mb-2">sales <a href="agingBalanceInformation.html"><i class="fa-solid fa-question bg-primary text-light p-1" style="border-radius: 50%;width: 22px;height: 22px;"></i></a></h2>
</div>
<div class="title-risk text-capitalize">
  <div class="container-fluid">
    <button class="mt-1 text-capitalize border-primary"><span><i class="fa-solid fa-chart-simple pe-2"></i></span> sales history</button>
  <hr class="">
  </div>
</div>
<div class="risk-1">
          ...
          <div class="col-lg-8">
            <div class="weeaks d-flex justify-content-between mb-3 text-capitalize">
              ...
              <div class="d-flex justify-content-end">
                ...
                <div class="chart-2">
                  <canvas id="myChart-1"  width="700" height="400"></canvas>
                </div>
          </div>
          <div class="col-lg-4">
...
<div class="texts text-capitalize">
  <div class="container-fluid">
    <div>
      ...
      <div class="row mt-2 px-4 text-center">
      ...
      <div class="row align-items-center pt-3" style="background-color: #006bff14" >
        <div class="col-3 col-md-1 mb-3 position-relative">
...
<div class="hidden ms-2 d-none">
    ...
    <div class="d-flex">
      ...
      <div class="row text-center mb-3">
        ...
        <div class="col-3 col-md-2">Total :37.9 M€</div>
        <div class="col-3 col-md-2">31.2 M€</div>
...
<!--texts-->
   ...
   <script src="./js/chart-9.js"></script>
