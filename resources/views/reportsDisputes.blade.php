        ...
        <li class="nav-item dropdown">
         ...
         <li class="nav-item dropdown">
           ...
           <ul class="dropdown-menu" aria-labelledby="settingsDropdown">
            ...
            <li><a class="dropdown-item text-primary" href="settings-manage-item-status.html"><i class="fa-regular fa-flag"></i> Manage payment profiles</a></li>
...
<div class="title-risk text-capitalize">
  <div class="container-fluid d-flex justify-content-between">
    <div class="d-flex">
      <button class="mt-1 text-capitalize p-0 border-primary" style="cursor: pointer;"><a href="#" class="text-decoration-none"><span><i class="fa-solid fa-pie-chart pe-2"></i></span>Current situation </a></button>
      <button class="mt-1 text-capitalize border-0" style="cursor: pointer;"><a href="reportsDisputesTrend.html" class="text-decoration-none"><span><i class="fa-solid fa-signal pe-2"></i></span>Trend </a></button>
          ...
          <div class="col-lg-8">
            <div class="d-flex justify-content-end">
              <i class="fa-solid fa-download text-secondary " style="font-size: 25px;"></i>
                ...
                <div class="chart-2">
                  <canvas id="myChart-15"  width="700" height="400"></canvas>
                </div>
                <div class="mt-3 text-center">
                    <div class="d-inline-flex">Average time for dispute resolution : <div class="fw-bold">  7 days</div></div>
                    <br>
                    <div class="d-inline-flex">Disputed receivable amount : <div class="fw-bold"> 222 K€ </div></div>
                </div>
          </div>
          <div class="col-lg-4">
            <div class="dispute-type text-capitalize ">
              ...
              <div class="not-empty d-flex align-items-center margin-ten-px">
                <input type="radio" name="inputs-group" id="all" class="margin-ten-px">
                <label for="all">[ All ]</label>
               <span>225 k€</span>
              </div>
              <div class="litige-administratif-checks-1 d-flex align-items-center margin-ten-px">
                <input type="radio" name="inputs-group" id="administratif" class="margin-ten-px">
                <label for="administratif">Litige administratif</label>
               <span>96 k€</span>
              </div>
  
              <div class="litige-livraison-check-3 d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-group" id="livraison" class="margin-ten-px">
                <label for="livraison">Litige livraison</label>
               <span>29.2 k€</span>
              </div>
              <div class="litige-matériel-manquant-checks-4 d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-group" id="manquant" class="margin-ten-px">
                <label for="manquant">Litige matériel manquant</label>
               <span> 212 k€</span>
              </div>
              <div class=" litige-prix-checks-5 d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-group" id="prix" class="margin-ten-px">
                <label for="prix"> Litige prix</label>
               <span>366 k€</span>
              </div>
              <div class="litige-qualité-checks-6 d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-group" id="qualité" class="margin-ten-px">
                <label for="qualité">Litige qualité</label>
               <span>366 k€</span>
              </div>
              <div class=" missing-po-checks-7 d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-group" id="PO" class="margin-ten-px">
                <label for="PO">Missing PO</label>
               <span>366 k€</span>
              </div>
              <div class=" price-dispute-checks-8 d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-group" id="Dispute" class="margin-ten-px">
  ...
  <div class="container-fluid">
    <div class="responive-report-5">
      ...
      <div class="row mt-2  align-items-center text-center">
        <div class="col m-0 p-0"><p class="fw-bold">Flag</p></div>
        ...
        <div class="col m-0 p-0 hide">
          <div class="d-flex align-items-center justify-content-center gap-1">
            
            <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
          <p class="fw-bold">Amount in disputes</p>
        </div>
        </div>
        ...
        <div class="col m-0 p-0 hide">
          <div class="d-flex align-items-center justify-content-center gap-1">
            ...
            <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
          <p class="fw-bold">No. Of item in disputes</p>
        </div>
      </div>
        ...
        <div class="col m-0 p-0 hide">
          <div class="d-flex align-items-center justify-content-center gap-1">
            <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
          <p class="fw-bold">Dispute Rate</p>
        </div> 
      </div>
        <div class="col-3 tavle-dropdown-icon"></div>
      </div>
...
<!--texts-->
   ...
   <script src="js/chart-15.js"></script>
