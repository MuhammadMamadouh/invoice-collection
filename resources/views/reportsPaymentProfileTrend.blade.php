...
<div class="title-risk text-capitalize">
  <div class="container-fluid d-lg-flex justify-content-between">
    <div>
      <a href="reportsPaymentProfile.html" class="mt-1 me-2 text-capitalize text-decoration-none text-primary border-0"><span><i class="fa-solid fa-chart-pie pe-2"></i></span> sales history</a>
      <button class="mt-1 text-capitalize border-primary "><span><i class="fa-solid fa-chart-simple pe-2"></i></span> Trend</button>
    </div>
    ...
    <div class="risk-1">
        <div class="container-fluid">
            <div class="row p-2 align-items-center">
                <div class="col-lg-8">
                  <div class="weeaks d-flex justify-content-between align-items-center text-capitalize">
                      <div>
                      ...
                      <div class="weeaks d-flex justify-content-end align-items-center  text-capitalize">
                        <div>
                          <span class="mb-5">Views : </span>
                          <input type="radio" id="line" name="checkbox">
                          <label for="line">lines</label>
                          <input type="radio" id="bars" name="checkbox">
                      ...
                      <div class="new-chart-page">
                        <canvas id="charts-lines"  width="700" height="400"></canvas>
                      </div>
...
<div class="texts text-capitalize">
    <div class="tabel-chart">
        <div class="container-fluid mt-5">
            <div class="table-responsive">
              <table class="table table-bordered table-custom">
                <thead style="font-size: 11.9px;">
                  <tr>
                    <th scope="col">Company Code</th>
                    <th scope="col">Company / Business Name</th>
                    <th scope="col">Week 29<br>07-15 → Today</th>
                    <th scope="col">Week 28<br>07-08 → 07-14</th>
                    <th scope="col">Week 27<br>07-01 → 07-07</th>
                    <th scope="col">Week 26<br>06-24 → 06-30</th>
                  </tr>
                </thead>
                <tbody  style="font-size: 13px; border: 2px solid #fff;">
                  <tr>
                    <td class="gray-color-tables"><a href="" class="d-flex justify-content-around"><span class=""><i class="fa-solid fa-bars"></i></span> 341231</a> </td>
                    <td class="gray-color-tables"><a href="">Vivarte</a></td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                  </tr>
                  <tr>
                    <td class=""><a href="" class="d-flex justify-content-around"><span class=""><i class="fa-solid fa-bars"></i></span> 391235</a> </td>
                    <td class=""><a href="">Thomason</a></td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                  ...
                  <tr>
                    <td class="gray-color-tables"><a href="" class="d-flex justify-content-around"><span><i class="fa-solid fa-bars"></i></span> 654245</a></td>
                    <td class="gray-color-tables"><a href="">Ashor</a></td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                  ...
                  <tr>
                    <td class=""><a href="" class="d-flex justify-content-around"><span><i class="fa-solid fa-bars"></i></span> 654245</a></td>
                    <td class=""><a href="">535055</a></td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                  ...
                  <tr>
                    <td class="gray-color-tables"><a href="" class="d-flex justify-content-around"><span><i class="fa-solid fa-bars"></i></span> 837524</a></td>
                    <td class="gray-color-tables"><a href="">Egetra</a></td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
                    <td class="status-very-good">Très bon payeur / Very good payer <br/> +29days</td>
...
<!--texts-->
   ...
   <script src="js/cahrtsLines.js"></script>
