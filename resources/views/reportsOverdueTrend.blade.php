    ...
    <div class="container">
      <div class="row pb-3">
        ...
        <div class="col-lg-6" style="height:300px ;">
          ...
          <canvas id="myChart-60"  width="200" height="200"></canvas>
        </div>
      </div>
    </div>
    </div>
...
<div class="header-risk">
  <h2 class="text-capitalize text-center mt-5 mb-2">Report overdue trend  <a href="overdueTrendInformation.html"><i class="fa-solid fa-question bg-primary text-light p-1" style="border-radius: 50%;width: 22px;height: 22px;"></i></a></h2>
</div>
<div class="title-risk text-capitalize">
  <div class="container-fluid d-flex justify-content-between">
    <div>
      <button class="mt-1 text-capitalize border-primary"><span><i class="fa-solid fa-clock-rotate-left me-2"></i></span>Overdue trend</button>
    </div>
</div>
<hr class="">
</div>
          ...
          <div class="col-lg-8">
            ...
            <div class="d-flex justify-content-end">
              <i class="fa-solid fa-download text-secondary " style="font-size: 25px;"></i>
                ...
                <div class="chart-2">
                  <canvas id="myChart-6"  width="700" height="400"></canvas>
                </div>

                <select class="form-select border-primary mt-4 mx-auto w-auto" aria-label="Default select example">
                  <option value="1" selected>Overdue Total</option>
                  <option value="2">Overdue +15 d</option>
                  <option value="2">Overdue +30 d</option>
                  <option value="2">Overdue +60 d</option>
                  <option value="2">Overdue +120 d</option>
                </select>
          </div>
          <div class="col-lg-4">
    ...
    <div class="responive-report-5">
      ...
      <div class="row mt-2 px-4 align-items-center text-center">
        ...
        <div class="col hide">
                                <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">overdue 15-04 -> Today</p>
              </div>
        ...
        <div class="col hide">
                                <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">week 15 08-04 -> 14-04</p>
              </div>
        ...
        <div class="col hide">
                                <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">week 14 01-04 -> 07-04</p>
              </div>
        ...
        <div class="col hide">
                                <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">week 13 25-03 -> 31-03</p>
              </div>
        ...
        <div class="col hide">
                                <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">week 12 18-03 -> 24-03</p>
              </div>
        ...
        <div class="col hide">
                                <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">week 11 11-03 -> 17-03</p>
              </div>
