...
<div class="header-risk">
  <h2 class="text-capitalize text-center mt-5 mb-2">Report Items status  <a href="reportsItemsStatusInformation.html"><i class="fa-solid fa-question bg-primary text-light p-1" style="border-radius: 50%;width: 22px;height: 22px;"></i></a></h2>
</div>
<div class="title-risk text-capitalize">
  <div class="container-fluid d-flex justify-content-between">
    <div class="d-flex">
      <button class="mt-1 text-capitalize border-0" style="cursor: pointer;"><a href="reportsItemsStatus.html" class="text-decoration-none"><span><i class="fa-solid fa-pie-chart pe-2"></i></span>Current situation </a></button>
      <button class="mt-1 text-capitalize border-primary " style="cursor: pointer;"><a href="#" class="text-decoration-none"><span><i class="fa-solid fa-signal pe-2"></i></span>Trend </a></button>
    </div>
</div>
<hr>
</div>
          ...
          <div class="col-lg-8">
            ...
            <div class="d-flex justify-content-end">
              <i class="fa-solid fa-download text-secondary " style="font-size: 25px;"></i>
                ...
                <div class="chart-2">
                  <canvas id="myChart-12"  width="700" height="400"></canvas>
                </div>
          </div>
          <div class="col-lg-4">
            <div class="type-of-stuts  text-capitalize ">
              <h6 class="fw-bold">Type of status<a href="settings-manage-item-status.html" target="_blank"><i class="fa-regular fa-share-from-square"></i></a></h6>
              ...
              <div class="not-empty d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-group" id="none" class="margin-ten-px">
                <label for="none">[ none ]</label>
              </div>
              <div class="green-checks-2 margin-ten-px d-flex align-items-center margin-ten-px">
              ...
              <div class="green-checks-3 margin-ten-px d-flex align-items-center margin-ten-px">
                <input type="radio" name="inputs-group" id="Resolved" class="margin-ten-px">
                <label for="Resolved">Dispute Resolved</label>
               <span class="margin-ten-px"></span>
              </div>
              <div class="yellows-checks-2 d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-group" id="Litigation" class="margin-ten-px">
                <label for="Litigation"> Litigation</label>
               <span class="margin-ten-px"></span>
              </div>
              <div class="ongoing-checks-2 d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-group" id="going" class="margin-ten-px">
                <label for="going">On going</label>
               <span class="margin-ten-px"> </span>
              </div>
              <div class="promise-checks-2 d-flex align-items-center margin-ten-px">
                 <input type="radio" name="inputs-group" id="Promise" class="margin-ten-px">
                <label for="Promise">Promise to pay</label>
               <span class="margin-ten-px"></span>
              </div>
            </div>
