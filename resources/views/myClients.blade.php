      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-3 col-md-4 col-sm-6">
            <a href="allClients.html" class="m-1 w-100 btn btn-outline-primary p-3">
              <i class="fa-solid fa-earth-asia"></i> &ensp; All clients &ensp;
              <span class="badge bg-primary">184</span>
            </a>
          </div>
          <div class="col-lg-3 col-md-4 col-sm-6">
            <a
              href="myClients.html"
              class="m-1 w-100 btn btn-primary text-white p-3"
              id="actionButton">
              <i class="fa-solid fa-building text-white"></i> &ensp; My
              clients &ensp;
