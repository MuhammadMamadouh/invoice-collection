    ...
    <div class="d-none" id="indicatorsDiv">
      <div class="sec-2 bg-white" >
        ...
        <div class="col-lg-6" style="height:300px ;">
            ...
            <canvas  id="myChart-50"  width="200" height="200"></canvas>
        </div>
              </div>
        </div>
      </div>
...
<div class="header-risk">
  <h2 class="text-capitalize text-center mt-5 mb-2">Aging balance trend <a href="agingBalanceInformation.html"><i class="fa-solid fa-question bg-primary text-light p-1" style="border-radius: 50%;width: 22px;height: 22px;"></i></a></h2>
</div>
<div class="title-risk text-capitalize">
  <div class="container-fluid d-flex flex-wrap justify-content-between">
    <div>
      <button class="mt-1 text-capitalize border-primary"><span><i class="fa-solid fa-chart-simple me-2"></i></span>Situation of your receivable</button>
    </div>
...
<div class="risk-1">
  <div class="container-fluid">
      <div class="row p-2">
          <div class="col-lg-8">
              <div class="weeaks  text-capitalize mb-5">
                    <div class="dropdown">
                ...
                <div class="chart-2">
                  <canvas id="myChart-5"  width="700" height="400"></canvas>
                </div>
                <div class="row">
                  <div class="col-lg-4 col-md-6 d-flex align-items-center "><p>Current receivable : <div class="badge bg-light text-dark mb-3 ms-2">€ &nbsp; 151k &nbsp; 42%</div></p></div>
                  <div class="col-lg-4 col-md-6 d-flex align-items-center "><p>Overdue : <div class="badge bg-light text-dark mb-3 ms-2">€ &nbsp; 209k &nbsp; 58%</div></p></div>
                  <div class="col-lg-4 col-md-6 d-flex align-items-center "><p>Total receivable : <div class="badge bg-light text-dark mb-3 ms-2">€ &nbsp; 359k &nbsp; 100%</div></p></div>
                </div>
                <div class="row">
                  <div class=" col-md-6 d-flex align-items-center "><p>Overdue % :</p>                 
                    <select class="form-select border-primary mb-2 w-auto" aria-label="Default select example">
                      <option value="1" selected>Total</option>
                      <option value="2">+15 d</option>
                      <option value="2">+30 d</option>
                      <option value="2">+60 d</option>
                      <option value="2">+120 d</option>
                    </select>
                    <div class="badge bg-light text-dark mb-3 ms-2">5%</div>
                  </div>
                  <div class="col-md-6 d-flex align-items-center "><p>Overdue +30 d: <div class="badge bg-light text-dark mb-3 ms-2">€ &nbsp; 161k &nbsp; 45%</div></p></div>
                </div>
          </div>
          <div class="col-lg-4">
    ...
    <div class="responive-report-5">
      ...
      <div class="row mt-2 px-4 align-items-center text-center">
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">31-60d</p>
          </div>
        </div>
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">61-120d</p>
          </div>
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">overdue% +30d code</p>
          </div>
      ...
      <div class="col-md-1 col-4 ">393 k€</div>
        <div class="col-md-1 col-4 ">393 k€</div>
      <div class="col-md-1 col-4 ">100%</div>
    </div>
  </div>
...
<!--texts-->
   ...
   <!-- <script src="js/chart-50.js"></script> -->
