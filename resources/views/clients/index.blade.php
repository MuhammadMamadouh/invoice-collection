            ...
            <div class="col-12">
                ...
                <div class="row mt-2 align-items-center px-4 text-center">
                    ...
                    <div class="col-3 hide">
                        <div class="d-flex align-items-center justify-content-center gap-1 ">
                            ...
                            {{-- <span class="conttt-3">
                                payment profile < payeur correct / <br>
                                    average payeur >
                                    <br>
                                    average days beyond
                                    <br>
                ...
                <div class="text-center mb-3 p-2 p-md-4 table-container">
                    ...
                    <div class="row align-items-center pt-3"
                        ...
                        <div class="col-1 hide">
                            <p class="fw-bold"><a href="#" onclick="showHolap({{ $client->id }})">{{
                                    $client->company_name }}</a></p>
                        </div>
                                    ...
                                    <div class="">
                                        <div class="btn-group">
                                            <button type="button" class="btn text-light"><span><i
                                                        class="fa-solid fa-download"></i>&ensp;</span>{{ __('Export this
                                                data to excel') }}</button>
                                            <button type="button"
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="mt-3 "><button type="button" class="btn"
                                                        style="width: 100%;"><span><i
                                                                class="fa-solid fa-download"></i>&ensp;</span>{{
                                                        __('download') }}</button>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="end-con d-flex justify-content-between">
                                    <h4 class="mt-2 mb-2"><span><i class="fa-regular fa-hand-point-right"></i></span>
                                        {{ __('Actions to do') }}:
                                        <span>?
                                            {{ __('read more') }}</span>
                                    </h4>
                                        ...
                                        <div class="container">
                                            <div class="col-12">
                                                <button class="mt-3" id="show-items-button"><span
                                                        class="text-black-50"><i class="fa-solid fa-pen"></i></span> add
                                                    an
                                                    item</button>
                                ...
                                <section class="button-to-back credit-limit-second-section credit-limit mt-2 d-none"
                                    id="showTwo">
