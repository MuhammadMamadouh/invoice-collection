                                        ...
                                        <div class="row m-0 p-3">
                                            ...
                                            <div class="col-lg-4 col-sm-6 text-start">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <p class="">{{$client->late_payment_penalties == 1 ? 'Yes' : 'No'}}</p>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <p class="fw-bold"><a href="">{{__("Recovery cost")}}</a>:</p>
                                                    <p class="">{{$client->recovery_cost == 1 ? 'Yes' : 'No'}}</p>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <p class="fw-bold"><a href="">{{__("Interactive emails")}}</a>:</p>
                                                    <p class="">{{$client->interactive_emails == 1 ? 'Yes' : 'No'}}</p>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 text-start">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <select class="form-select m-auto w-50"
                                                        ...
                                                        <option value="1">Scenario de relance standard (by default)</option>
