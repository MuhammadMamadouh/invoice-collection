                ...
                <div class="row">
                    ...
                    <div class="col-md-4 my-2">
                        ...
                        <div class="col-7 d-flex justify-content-between  ">
                            <div class="form-check ">
                                <input class="form-check-input" type="checkbox" id="exampleCheckbox1">
                                <label class="form-check-label" for="exampleCheckbox1" name="interactive_emails" value="true">Yes</label>
                            </div>
                            <div class="form-check d-flex">
                                <input class="form-check-input" type="checkbox" id="exampleCheckbox2">
                                <label class="form-check-label " for="exampleCheckbox2" name="interactive_emails" value="false">No</label>
                            </div>
                        </div>
                    </div><!--24-->
                    <div class="col-md-4 my-2">
