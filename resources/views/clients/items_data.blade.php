<div class="invoice d-none" id="show-invoice-{{ $item->id }}">
        ...
        <div class="row text-center m-0 p-1 w-100" style="background-color: #006bff">
            <div class="d-flex justify-content-between ">
                <div class="text-start">
                    <h2 class="text-light">{{__("Invoice")}} <span class="fw-bold ps-2">{{ $item->trans_no ?? '-' }}</span></h2>
                    <p><i class="fa-solid fa-building text-light"></i><a href="#" class="text-light ps-2">{{$client->address}}</a></p>
                </div>
                <div class="d-flex justify-content-end gap-3 mt-2">
                    <div class="icon-holab  ">
                        ...
                        <a href="invoice.html" target="_blank"><i
    ...
    <div class="bg-white d-none " id="associatedDiv">
        ...
        <div class="p-4">
            ...
            <div class="btn text-primary" onclick="addFileFunction()"><i class="fa-solid fa-link"></i>&ensp;{{__("Add")}}
                {{__("File")}}</div><br>
