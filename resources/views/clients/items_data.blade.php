<div class="invoice d-none" id="show-invoice-{{ $item->id }}">
    <div class="bg-light invoice-first-{{$item->id}}">
        <div class="row text-center m-0 p-1 w-100" style="background-color: #006bff">
            <div class="d-flex justify-content-between ">
                <div class="text-start">
                    <h2 class="text-light">{{__("Invoice")}} <span class="fw-bold ps-2">{{ $item->trans_no ?? '-'
                            }}</span></h2>
                ...
                <div class="d-flex justify-content-end gap-3 mt-2">
                    <div class="icon-holab  ">
                        ...
                        <i class="fa-solid fa-close text-light p-2 bg-danger" onclick="closeInvoice({{$item->id}})"
                            style="  font-size: 15px; cursor: pointer; border-radius: 5px;"></i>
                    </div>
                </div>
            </div>
        ...
        <div class="row p-4 m-0">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="m-1 w-100 btn btn-outline-primary associatedButton" onclick="associatedFun({{$item->id}})">
    ...
    <div class="step-1">
        ...
        <div class="px-5">
            <div class="d-flex">
                ...
                <a href="DSOInformation.html"><svg class="svg-inline--fa fa-question bg-secondary text-light p-1 ms-1"
                        style="border-radius: 50%;width: 15px;height: 18px;font-size: 12px !important;"
                        aria-hidden="true" focusable="false" data-prefix="fas" data-icon="question" role="img"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="">
                        <path fill="currentColor"
        ...
        <div class="d-flex justify-content-end">
            <div class="btn btn-secondary px-5 mx-5" onclick=" showStepTwo()">Next <svg
                    class="svg-inline--fa fa-chevron-right ps-2" aria-hidden="true" focusable="false" data-prefix="fas"
    ...
    <div class="step-2 d-none">
        ...
        <div class="d-flex justify-content-end">
            <div class="btn btn-danger px-5 mx-5" onclick=" showStepOne()"><svg
                    class="svg-inline--fa fa-chevron-left pe-2" aria-hidden="true" focusable="false" data-prefix="fas"
                ...
                </svg><!-- <i class="fa-solid fa-chevron-left pe-2"></i> Font Awesome fontawesome.com --> Previus</div>
    ...
    <div class="step-3 d-none">
            ...
            <div class=" my-2">
                <form class="d-flex">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-text"><svg class="svg-inline--fa fa-calendar-days" aria-hidden="true"
                                focusable="false" data-prefix="fas" data-icon="calendar-days" role="img"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                <path fill="currentColor"
        ...
        <div class="d-flex justify-content-end my-5">
            ...
            <div class="btn btn-success px-5 mx-5"> <svg class="svg-inline--fa fa-check pe-2" aria-hidden="true"
                    focusable="false" data-prefix="fas" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg"
