    ...
    <div class="container">
      <div class="row pb-5 align-items-center" style="height:500px ;">
        ...
        <div style="height:300px ;">
          <canvas id="myChart-30" width="100" height="100"></canvas>
        </div>
      </div>
    </div>
    </div>
...
<div class="header-risk">
  <h2 class="text-capitalize text-center mt-5 mb-2">Cash Forecast
    <a href="#"><i class="fa-solid fa-question bg-primary text-light p-1" style="border-radius: 50%;width: 22px;height: 22px;"></i>
    </a>
  </h2>
</div>
<div class="title-risk text-capitalize d-flex">
  <div class="container-fluid">
    <button class="mt-1 text-capitalize border-primary"><span><i class="fa-solid fa-wand-magic-sparkles pe-2"></i></span>Forecast</button>
...
<div class="risk-1">
  <div class="container-fluid">
      <div class="row p-2 align-items-center">
          <div class="col-lg-8">
              <div class="weeaks d-flex flex-wrap align-items-center justify-content-between text-capitalize mb-5" style="font-size: 15px;">
                  <div>
                  ...
                  <div class="d-flex flex-wrap">
                    <div>
                      <input type="checkbox" id="payment" name="checkbox">
                      <label class="fw-bold" for="payment">include Payment behavior </label>
                    </div>
                    <div>
                      <input type="checkbox" id="dispute" name="checkbox">
                      <label class="fw-bold" for="dispute">include dispute resolution time</label>
                    </div>
                  </div>
                ...
                <div class="chart-2">
                  <canvas id="myChart-3" width="700" height="500" ></canvas>
                </div>
                <div class="d-flex  justify-content-around text-capitalize">
                  <div class=" d-flex align-items-center "><p class="pb-0 mb-0">total forecast (3 month): <p class="badge bg-secondary text-light mt-3 ms-2" style="border-radius: 10px;">10.916k€</p></p></div>
                  <div class=" d-flex align-items-center "><p class="pb-0 mb-0">Promise to pay: <p class="badge  bg-secondary text-light mt-3 ms-2"  style="border-radius: 10px;">464k€</p></p></div>
                </div>
                
                <div class="d-flex justify-content-around text-capitalize">
                  <div class=" d-flex align-items-center "><p>amount of forecast: <p class=" text-dark mb-3 ms-2">4.503k€</p></p></div>
                  <div class=" d-flex align-items-center "><p>no of items:</p><p class=" text-dark mb-3 ms-2">50</p></div>  
                </div>              
          </div>
          <div class="col-lg-4">
  ...
  <div class="container-fluid">
    <div>
      ...
      <div class="row mt-2 text-center align-items-center">
          <div class="col "><p class="fw-bold">Flag</p></div>
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1">
            <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
            <p class="fw-bold">Amount off forecast</p>
        </div>
        </div>
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1">
            <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
          <p class="fw-bold">Week16 Today -> 04-28</p>
        </div>
        </div>
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1">
            <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
          <p class="fw-bold">Week16 29-04 -> 05-05</p>
        </div>
        </div>
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1">
            <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
          <p class="fw-bold">Total forecast 3 month</p>
        </div>
        </div>
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1">
            <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
          <p class="fw-bold">Forecast > 3month</p>
        </div>
        </div>
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1">
            <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
          <p class="fw-bold">Average Time Of Payment</p>
        </div>
        </div>
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1">
            <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
          <p class="fw-bold">Average Days Beyond Terms</p>
        </div>
        </div>
      ...
      <div class="text-center mb-3 " > 
        <div class="row align-items-center pt-3" style="background-color: #006bff14" >
          ...
          <div class="col hide">
            <p class="fw-bold">1,506 k€</p>
          </div>
          <div class="col hide">
            <p class="fw-bold">45,342.75 €</p>
          </div>
          <div class="col hide">
            <p class="fw-bold">37,077.02 €</p>
          </div>
          <div class="col hide">
            <p class="fw-bold">11,187.32 €</p>
          </div>
      ...
      <div class="row text-center mb-3" style="font-size:12px ;">
        <div class="col-1 mb-3 hide"></div>
        <div class="col-3 col-md-2 hide"></div>
        <div class="col-3 col-md-2 hide"></div>
        <div class="col">Total :37.9 M€</div>
        <div class="col">31.2 M€</div>
        <div class="col">6.6 M€</div>
        <div class="col">1.7 k€</div>
        <div class="col">31.2 M€</div>
    </div>
    </div>
...
<!--texts-->
   ...
   <script src="./js/chart-30.js"></script>
