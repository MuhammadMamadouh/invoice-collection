        ...
        <li class="nav-item dropdown">
         ...
         <li class="nav-item dropdown">
           ...
           <ul class="dropdown-menu" aria-labelledby="settingsDropdown">
            ...
            <li><a class="dropdown-item text-primary" href="settings-manage-payment-profile.html"><i class="fa-regular fa-flag"></i> Manage payment profiles</a></li>            <li><a class="dropdown-item text-primary" href="settings-manage-risk-settings.html"><i class="fa-solid fa-bolt"></i> Manage risk</a></li>
  ...
  <section class="mt-5">
    <div class="container-fluid">
      <div class="row">
        ...
        <!--btns-->
        <div class="col-lg-3 col-md-4 col-sm-6">
          <a href="collectionActionsHistoy.html" class="m-1 w-100 btn btn-primary text-light p-3"><i class="fa-solid fa-bars-staggered"></i>
            Actions history</a>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6">
        ...
        <form class="row justify-content-center">
          <div class="col-lg-1 col-md-2 col-sm-3 dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="reportsDropdown">
              ...
              <li><a class="dropdown-item text-primary" href="#" onclick="showCharts2()"><i class="fa-solid fa-thumbs-up"></i> Actions done</a>
              </li>
              <li><a class="dropdown-item text-primary" href="#" onclick="showCharts3()"><i class="fa-solid fa-clock-rotate-left"></i> Actions
                  Forecast</a></li>
            </ul>
          </div>
      ...
      <div class="row p-3 bg-light d-none collection-charts-1">
        <div class="col-lg-3">
          ...
          <div class="my-3">
            ...
            <input type="radio" id="Number" name="checkbox">
            <label for="Number">Number</label>
            <input type="radio" id="Amount" name="checkbox">
      ...
      <div class="row p-3 bg-light d-none collection-charts-2">
        ...
        <div class="col-lg-9 bg-white" style="height:400px ;">
          <canvas id="myChart-60" width="700" height="400"></canvas>
        </div>
      ...
      <div class="row p-3 bg-light d-none collection-charts-3">
        ...
        <div class="col-lg-9 bg-white" style="height:400px ;">
          <canvas id="myChart-80" width="700" height="400"></canvas>
        </div>
      ...
      <div class="text-center mb-3  p-2 p-md-4">
        <div class="row align-items-center pt-3"  style="background-color: #006bff14">
          <div class="col">
            ...
            <span class="conttt">due date: sunday, may 2022 <br> / action 4 days after due date of <br> oldest invoice </span>
          </div>
          </div>
          <div class="col-md-2 d-flex col-5">
            <div class="btn openModalBtn btn-primary w-100 mb-3" style="border-radius:5px 0 0 5px ">
              @ E-mail
            </div>
            <div class="btn btn-success mb-3" style="border-radius:0 5px 5px 0">
              <i class="fa-solid fa-download"></i>
            </div>
          </div>
          <div class="col-2 hide">
            <p><a href="#" onclick="showInvoice()">C35322</a>, <a href="#" onclick="showInvoice()">F43443</a></p>
          </div>
          <div class="col-1 hide">
