    ...
    <div class="mb-0 top-navbar ">
        ...
        <div class="container">
            ...
            <a href="settings.html" class="mt-4 "> <svg class="svg-inline--fa fa-house" aria-hidden="true"
                    focusable="false" data-prefix="fas" data-icon="house" role="img" xmlns="http://www.w3.org/2000/svg"
                ...
                </svg><!-- <i class="fa-solid fa-house"></i> Font Awesome fontawesome.com --></a><a href="#"> {{__("My
                account")}}</a>
        ...
        <div class="container">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                ...
                <span class="navbar-toggler-icon">
                    <span class="text-light"><svg class="p-1 svg-inline--fa fa-bars" aria-hidden="true"
                        ...
                        </svg><!-- <i class="p-1 fa-solid fa-bars"></i> Font Awesome fontawesome.com --></span>
                </span>
            </button>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="mb-2 text-center navbar-nav ms-auto mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><span><svg class="svg-inline--fa fa-clock" aria-hidden="true"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('clients.index')}}"><span><svg class="svg-inline--fa fa-globe"
                                    aria-hidden="true" focusable="false" data-prefix="fas" data-icon="globe" role="img"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                    <path fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><span><svg class="svg-inline--fa fa-magnifying-glass"
                                ...
                                <!-- <i class="fa-solid fa-magnifying-glass"></i> Font Awesome fontawesome.com --></span>
                            search</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="reportsDropdown" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false" href="#"><span><svg class="svg-inline--fa fa-chart-simple"
                                ...
                                <!-- <i class="fa-solid fa-chart-simple"></i> Font Awesome fontawesome.com --></span>
                            reports</a>
                        <ul class="dropdown-menu" aria-labelledby="reportsDropdown">
                            <li><a class="dropdown-item text-primary" href="#"><svg
                                    ...
                                    <!-- <i class="fa-solid fa-chart-simple "></i> Font Awesome fontawesome.com -->
                                    Aging balance</a></li>
                            <li><a class="dropdown-item text-primary" href="#"><svg
                                    ...
                                    <!-- <i class="fa-solid fa-clock-rotate-left"></i> Font Awesome fontawesome.com -->
                                    Overdue trend</a></li>
                            <li><a class="dropdown-item text-primary" href="#"><svg class="svg-inline--fa fa-chart-line"
                                        aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chart-line"
                                        role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                        data-fa-i2svg="">
                                        <path fill="currentColor"
                                    ...
                                    DSO</a></li>
                            <li><a class="dropdown-item text-primary" href="#"><svg class="svg-inline--fa fa-chart-pie"
                                        aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chart-pie"
                                    ...
                                    Items status</a></li>
                            <li><a class="dropdown-item text-primary" href="#"><svg
                                        class="svg-inline--fa fa-handshake-simple" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="handshake-simple" role="img"
                                    ...
                                    <!-- <i class="fa-solid fa-handshake-simple"></i> Font Awesome fontawesome.com -->
                                    Disputes</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item text-primary" href="#"><svg class="svg-inline--fa fa-signal"
                                        aria-hidden="true" focusable="false" data-prefix="fas" data-icon="signal"
                                        role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
                                        data-fa-i2svg="">
                                        <path fill="currentColor"
                                    ...
                                    Sales</a></li>
                            <li><a class="dropdown-item text-primary" href="#"><svg
                                        class="svg-inline--fa fa-money-bill-1-wave" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="money-bill-1-wave" role="img"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                        <path fill="currentColor"
                                    ...
                                    <!-- <i class="fa-solid fa-money-bill-1-wave"></i> Font Awesome fontawesome.com -->
                                    Cash receipts</a></li>
                            <li><a class="dropdown-item text-primary" href="#"><svg
                                        class="svg-inline--fa fa-wand-magic-sparkles" aria-hidden="true"
                                        focusable="false" data-prefix="fas" data-icon="wand-magic-sparkles" role="img"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                                        <path fill="currentColor"
                                    ...
                                    <!-- <i class="fa-solid fa-wand-magic-sparkles"></i> Font Awesome fontawesome.com -->
                                    Cash Forecast</a></li>
                            <li><a class="dropdown-item text-primary" href="#"><svg
                            ...
                            <li><a class="dropdown-item text-primary" href="#"><svg class="svg-inline--fa fa-bolt me-2"
                                    ...
                                    <!-- <i class="fa-solid fa-bolt me-2"></i> Font Awesome fontawesome.com -->Risk</a>
                            </li>
                            <li><a class="dropdown-item text-primary" href="#"><svg class="svg-inline--fa fa-flag me-2"
                                    ...
                                    <!-- <i class="fa-solid fa-flag me-2"></i> Font Awesome fontawesome.com -->Payment
                                    profile</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="settingsDropdown" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false"><span><svg class="svg-inline--fa fa-gear"
                                    aria-hidden="true" focusable="false" data-prefix="fas" data-icon="gear" role="img"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                    <path fill="currentColor"
                                        d="M495.9 166.6C499.2 175.2 496.4 184.9 489.6 191.2L446.3 230.6C447.4 238.9 448 247.4 448 256C448 264.6 447.4 273.1 446.3 281.4L489.6 320.8C496.4 327.1 499.2 336.8 495.9 345.4C491.5 357.3 486.2 368.8 480.2 379.7L475.5 387.8C468.9 398.8 461.5 409.2 453.4 419.1C447.4 426.2 437.7 428.7 428.9 425.9L373.2 408.1C359.8 418.4 344.1 427 329.2 433.6L316.7 490.7C314.7 499.7 307.7 506.1 298.5 508.5C284.7 510.8 270.5 512 255.1 512C241.5 512 227.3 510.8 213.5 508.5C204.3 506.1 197.3 499.7 195.3 490.7L182.8 433.6C167 427 152.2 418.4 138.8 408.1L83.14 425.9C74.3 428.7 64.55 426.2 58.63 419.1C50.52 409.2 43.12 398.8 36.52 387.8L31.84 379.7C25.77 368.8 20.49 357.3 16.06 345.4C12.82 336.8 15.55 327.1 22.41 320.8L65.67 281.4C64.57 273.1 64 264.6 64 256C64 247.4 64.57 238.9 65.67 230.6L22.41 191.2C15.55 184.9 12.82 175.3 16.06 166.6C20.49 154.7 25.78 143.2 31.84 132.3L36.51 124.2C43.12 113.2 50.52 102.8 58.63 92.95C64.55 85.8 74.3 83.32 83.14 86.14L138.8 103.9C152.2 93.56 167 84.96 182.8 78.43L195.3 21.33C197.3 12.25 204.3 5.04 213.5 3.51C227.3 1.201 241.5 0 256 0C270.5 0 284.7 1.201 298.5 3.51C307.7 5.04 314.7 12.25 316.7 21.33L329.2 78.43C344.1 84.96 359.8 93.56 373.2 103.9L428.9 86.14C437.7 83.32 447.4 85.8 453.4 92.95C461.5 102.8 468.9 113.2 475.5 124.2L480.2 132.3C486.2 143.2 491.5 154.7 495.9 166.6V166.6zM256 336C300.2 336 336 300.2 336 255.1C336 211.8 300.2 175.1 256 175.1C211.8 175.1 176 211.8 176 255.1C176 300.2 211.8 336 256 336z">
                                    </path>
                        ...
                        <ul class="dropdown-menu" aria-labelledby="settingsDropdown">
                            <li><a class="dropdown-item text-primary" href="{{ route('users.index') }}"><svg
                                    ...
                                    </svg><!-- <i class="fa-solid fa-users"></i> Font Awesome fontawesome.com --> Manage
                                    users account</a></li>
                            <li><a class="dropdown-item text-primary" href="#"><svg class="svg-inline--fa fa-lock"
                                    ...
                                    </svg><!-- <i class="fa-solid fa-lock"></i> Font Awesome fontawesome.com --> Secure
                                    my account and user accounts</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item text-primary" href="{{route('import-export')}}"><svg class="svg-inline--fa fa-rotate"
                                        aria-hidden="true" focusable="false" data-prefix="fas" data-icon="rotate"
                                        role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                        data-fa-i2svg="">
                                        <path fill="currentColor"
                            ...
                            <li><a class="dropdown-item text-primary" href="#"><svg class="svg-inline--fa fa-robot"
                                        aria-hidden="true" focusable="false" data-prefix="fas" data-icon="robot"
                                    ...
                                    </svg><!-- <i class="fa-solid fa-robot"></i> Font Awesome fontawesome.com --> Manage
                                    search assign</a></li>
                            <li><a class="dropdown-item text-primary" href="{{route('clients.create')}}"><svg
                                    ...
                                    </svg><!-- <i class="fa-solid fa-plus"></i> Font Awesome fontawesome.com --> Create
                                    a client</a></li>
                            <li><a class="dropdown-item text-primary" href="{{route('items.create')}}"><svg
                                        class="svg-inline--fa fa-plus" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 448 512" data-fa-i2svg="">
                                        <path fill="currentColor"
                            ...
                            <li><a class="dropdown-item text-primary" href="{{route('clients-group.index')}}"><svg
                                    ...
                                    <!-- <i class="fa-regular fa-folder-open"></i> Font Awesome fontawesome.com -->
                                    Manage clients group</a></li>
                            <li><a class="dropdown-item text-primary"
                                    href="{{route('collection_scenarios.index')}}"><svg class="svg-inline--fa fa-clock"
                            ...
                            {{-- <li><a class="dropdown-item text-primary" href="#"><svg
                                    ...
                                    <!-- <i class="fa-regular fa-square-check"></i> Font Awesome fontawesome.com -->
                                    Manage item status</a></li> --}}
                            <li><a class="dropdown-item text-primary" href="#"><svg class="svg-inline--fa fa-flag"
                                        aria-hidden="true" focusable="false" data-prefix="far" data-icon="flag"
                                        role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                        data-fa-i2svg="">
                                        <path fill="currentColor"
                            ...
                            <li><a class="dropdown-item text-primary" href="{{ route('item-status.index') }}"><svg
                                        class="svg-inline--fa fa-square-check" aria-hidden="true" focusable="false"
                                        data-prefix="far" data-icon="square-check" role="img"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                                        <path fill="currentColor"
                            ...
                            <li><a class="dropdown-item text-primary" href="#"><svg class="svg-inline--fa fa-bolt"
                                    ...
                                    risk</a></li>
                            <li><a class="dropdown-item text-primary" href="#"><svg class="svg-inline--fa fa-computer"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><span><svg class="svg-inline--fa fa-circle-info" aria-hidden="true"
                                ...
                                <!-- <i class="fa-solid fa-circle-info"></i> Font Awesome fontawesome.com --></span>
                            helps</a>
                    </li>
                    <div class="icons-nav">
                        <a href="#"><svg class="svg-inline--fa fa-book" aria-hidden="true" focusable="false"
                                data-prefix="fas" data-icon="book" role="img" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 448 512" data-fa-i2svg="">
                                <path fill="currentColor"
                                    d="M448 336v-288C448 21.49 426.5 0 400 0H96C42.98 0 0 42.98 0 96v320c0 53.02 42.98 96 96 96h320c17.67 0 32-14.33 32-31.1c0-11.72-6.607-21.52-16-27.1v-81.36C441.8 362.8 448 350.2 448 336zM143.1 128h192C344.8 128 352 135.2 352 144C352 152.8 344.8 160 336 160H143.1C135.2 160 128 152.8 128 144C128 135.2 135.2 128 143.1 128zM143.1 192h192C344.8 192 352 199.2 352 208C352 216.8 344.8 224 336 224H143.1C135.2 224 128 216.8 128 208C128 199.2 135.2 192 143.1 192zM384 448H96c-17.67 0-32-14.33-32-32c0-17.67 14.33-32 32-32h288V448z">
                        ...
                        <div class="px-4 py-2 rounded search-container" id="search-container">
                            <p>Quick search :</p>
                            <div class="input-group w-100 ">
                                ...
                                <span class="input-group-text bg-primary"><a href="#"><svg
                                            class="text-white svg-inline--fa fa-magnifying-glass" aria-hidden="true"
                                        ...
                                        <!-- <i class="text-white fa-solid fa-search"></i> Font Awesome fontawesome.com --></a></span>
                            </div>
