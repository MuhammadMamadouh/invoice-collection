                ...
                <ul class="navbar-nav ms-auto text-center mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="settingsDropdown">
                            ...
                            <li><a class="dropdown-item text-primary" href="#"><svg class="svg-inline--fa fa-rotate"
                        ...
                        <div class="search-container px-4 py-2 rounded" id="search-container">
                            ...
                            <div class="input-group w-100 ">
                                ...
                                <span class="input-group-text bg-primary"><a href="#"><svg
                                        ...
                                        <!-- <i class="fa-solid fa-search text-white"></i> Font Awesome fontawesome.com --></a></span>
                            </div>
