...
<div class=" p-2 text-center">
    ...
    <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-3">
              <div class="change-pages">
                <a href="collection.html" class="d-flex justify-content-between bg-secondary px-2 text-light"><svg class="svg-inline--fa fa-clock text-light" style="font-size: 35px;" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="clock" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512zM232 256C232 264 236 271.5 242.7 275.1L338.7 339.1C349.7 347.3 364.6 344.3 371.1 333.3C379.3 322.3 376.3 307.4 365.3 300L280 243.2V120C280 106.7 269.3 96 255.1 96C242.7 96 231.1 106.7 231.1 120L232 256z"></path></svg><!-- <i class="fa-solid fa-clock text-light" style="font-size: 35px;"></i> Font Awesome fontawesome.com -->
                <div class="block-txt">
            ...
            <div class="col-lg-4 col-md-6 mb-3">
              <div class="change-pages">
                <a href="reportsAgingBalance.html" class="d-flex justify-content-between bg-primary  px-2 text-light"><svg class="svg-inline--fa fa-euro-sign text-light" style="font-size: 35px;" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="euro-sign" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg=""><path fill="currentColor" d="M64 240C46.33 240 32 225.7 32 208C32 190.3 46.33 176 64 176H92.29C121.9 92.11 201.1 32 296 32H320C337.7 32 352 46.33 352 64C352 81.67 337.7 96 320 96H296C238.1 96 187.8 128.4 162.1 176H288C305.7 176 320 190.3 320 208C320 225.7 305.7 240 288 240H144.2C144.1 242.6 144 245.3 144 248V264C144 266.7 144.1 269.4 144.2 272H288C305.7 272 320 286.3 320 304C320 321.7 305.7 336 288 336H162.1C187.8 383.6 238.1 416 296 416H320C337.7 416 352 430.3 352 448C352 465.7 337.7 480 320 480H296C201.1 480 121.9 419.9 92.29 336H64C46.33 336 32 321.7 32 304C32 286.3 46.33 272 64 272H80.15C80.05 269.3 80 266.7 80 264V248C80 245.3 80.05 242.7 80.15 240H64z"></path></svg><!-- <i class="fa-solid fa-euro text-light" style="font-size: 35px;"></i> Font Awesome fontawesome.com -->
                <div class="block-txt">
              ...
              <div class="show-txt" id="show" style="display: none;">
                ...
                <div class="mt-3 mx-2" style="height:320px ;">
                    <a href="reportsAgingBalance.html">
                      <canvas id="myChart-5" width="362" height="250" style="display: block; box-sizing: border-box; height: 250px; width: 362px;"></canvas>
                    </a>
                    <div class="row text-center mt-3" style="font-size:10px ;">
                      <div class="col-6 d-flex align-items-center "><p>Current&nbsp;receivable&nbsp;: </p><div class="badge bg-light text-dark mb-3 ms-2">€ &nbsp; 151k &nbsp; 42%</div><p></p></div>
                      <div class="col-6 d-flex align-items-center "><p>Overdue&nbsp;: </p><div class="badge bg-light text-dark mb-3 ms-2">€ &nbsp; 209k &nbsp; 58%</div><p></p></div>
                      <div class="col-6 d-flex align-items-center "><p>Total receivable&nbsp;: </p><div class="badge bg-light text-dark mb-3 ms-2">€ &nbsp; 359k &nbsp; 100%</div><p></p></div>
              ...
              <div class="show-txt-2" id="show-2" style="display: none;">
                ...
                <div class="mt-3 mx-2" style="height:320px ;">
                    <a href="reportsItemsStatus.html">
                        <canvas id="myChart-11" width="362" height="250" style="display: block; box-sizing: border-box; height: 250px; width: 362px;"></canvas>
                    </a>
              ...
              <a href="reportsCashForecast.html" class="text-decoration-none"><h5 class="text-dark text-center">Cash forecast</h5></a>
                <div class="mt-3 mx-2" style="height:320px ;">
                    <a href="reportsCashForecast.html">
                        <canvas id="myChart-3" width="362" height="250" style="display: block; box-sizing: border-box; height: 250px; width: 362px;"></canvas>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mb-3">
                    ...
                    <div>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="form-group d-flex align-items-center">
                              <select class="form-select w-auto m-2" style="font-size:13px ;" aria-label="Default select example">
                            ...
                            <form>
                              <div class="form-group">
                                <input type="text" style="font-size:10px ;" class="form-control" aria-describedby="emailHelp" placeholder="Multi-columns search">
                              </div>
                            </form>
                          </div>
              ...
              <a href="reportsDSO.html" class="text-decoration-none"><h5 class="text-dark text-center">DSO trend</h5></a>
                <div class="mt-3 mx-2" style="height:320px ;">
                    <a href="reportsDSO.html">
                        <canvas id="myChart-8" width="362" height="250" style="display: block; box-sizing: border-box; height: 250px; width: 362px;"></canvas>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mt-5 mb-3">
              <a href="reportsOverdueTrend.html" class="text-decoration-none"><h5 class="text-dark text-center">Overdue trend</h5></a>
                <div class="mt-3 mx-2" style="height:320px ;">
                    <a href="reportsOverdueTrend.html">
                        <canvas id="myChart-6" width="362" height="250" style="display: block; box-sizing: border-box; height: 250px; width: 362px;"></canvas>
                    </a>
                </div>
            </div>
        </div>
