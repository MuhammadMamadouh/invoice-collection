...
<div class="position-fixed add-action-div pop-up d-none w-75 pt-4 pe-4" id="add-action-div-{{ $collection->id }}"
    ...
    <form action="{{ route('collection.storeAction') }}" method="POST">
        ...
        {{-- <input type="hidden" id="collection_scenario_id" name="collection_scenario_id"
            value="{{ $collection->id }}"class="form-control" style="width: 355px;"> --}}
                ...
                <div
                    ...
                    <select class="form-select" id="inputname19">
                        ...
                        <option value="">Clients risqués (FR) / Courrier avec accusé réception (Dunning letter
                            -
                            Français)</option>
                        <option value="">Key accounts scenario (EN) / Reminder by post mail with acknowledge
                            of
                            receipt (Dunning letter)</option>
                        <option value="">Risky clients (EN) / Formal notice (Dunning letter)</option>
                        <option value="">Risky clients (EN) / Reminder by post mail with acknowledge of
                            receipt
                            (Dunning letter)</option>
                        <option value="">Clients risqués (FR) / Courrier de mise en demeure (Dunning letter
                            via
                            ERM - Français)</option>
                        <option value="">Scénario de relance standard / Courrier de mise en demeure (Dunning
                            letter via ERM - Français)</option>
                        <option value="">Standard Collection Scenario / Letter of formal notice (Dunning
                            letter
                            via ERM)</option>
                    </select>
                    <div class="row">
                        ...
                        <div class="col-md-2 mt-1">
                            ...
                            <p style="color: rgb(172, 169, 169); text-align: center;"><svg
                                ...
                                <a href="#" style="font-size:10px;">Incorporate dynamic content in your
                                    letters
                                    with #Hashtag</a>
                            </p>
                        </div><!--l-4-->
