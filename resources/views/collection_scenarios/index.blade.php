 ...
 width: 100%;
    ...
    <form action="{{ route('collection.storeAction') }}" method="POST">
        ...
        <div class="bg-white m-auto p-4 shadow-sm position-relative" style="border-radius: 10px;">
            <span class="btn btn-secondary position-absolute" onclick="hideAddActionDiv()"
                ...
                <div class="col-12">
                    <div class="input-group">
                        <label for="inputname20">No. Of Days Follow-Up Action <a href="#"><svg
                                ...
                                <!-- <i class="fa-solid fa-question bg-primary text-light p-1" style="border-radius: 50%;width: 18px;height: 22px;"></i> Font Awesome fontawesome.com --></a>:</label>
    ...
    height: 400px;">
                    <select class="form-select" id="inputname19">
                        ...
                        <option value=""></option>
                        <option value="">Clients publics (FR) / Courrier avec accusé réception (Dunning letter -
                            Français)</option>
                        <option value="">Clients risqués (FR) / Courrier avec accusé réception (Dunning letter -
                            Français)</option>
                        <option value="">Key accounts scenario (EN) / Reminder by post mail with acknowledge of receipt
                            (Dunning letter)</option>
                        <option value="">Risky clients (EN) / Formal notice (Dunning letter)</option>
                        <option value="">Risky clients (EN) / Reminder by post mail with acknowledge of receipt (Dunning
                            letter)</option>
                        <option value="">Clients risqués (FR) / Courrier de mise en demeure (Dunning letter via ERM -
                            Français)</option>
                        <option value="">Scénario de relance standard / Courrier de mise en demeure (Dunning letter via
                            ERM - Français)</option>
                        <option value="">Standard Collection Scenario / Letter of formal notice (Dunning letter via ERM)
                        </option>
                    </select>
                    <div class="row">
                        ...
                        <div class="col-md-2 mt-1">
                            ...
                            <p style="color: rgb(172, 169, 169); text-align: center;"><svg
                                    ...
                                    data-prefix="fas" data-icon="hashtag" role="img" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 448 512" data-fa-i2svg="" style="height:30px;font-size: 2rem;">
                                    <path fill="currentColor"
                                ...
                                <!-- <i class="fa-solid fa-hashtag hash mb-4"></i> Font Awesome fontawesome.com --><br>
                                <a href="#" style="font-size:10px;">Incorporate dynamic content in your letters with
                                    #Hashtag</a>
                            </p>
                        </div>
                        <!--l-4-->
                        <div class="col-md-10 mt-1">
                            <div class="editor-container mb-1">
                                <div class="toolbar">
                                    ...
                                    <button onclick="execCmd('italic')"><svg class="svg-inline--fa fa-italic"
                                        ...
                                        <!-- <i class="fas fa-italic"></i> Font Awesome fontawesome.com --></button>
                                    <button onclick="execCmd('underline')"><svg class="svg-inline--fa fa-underline"
                                            aria-hidden="true" focusable="false" data-prefix="fas" data-icon="underline"
                                        ...
                                        <!-- <i class="fas fa-underline"></i> Font Awesome fontawesome.com --></button>
                                    <button onclick="execCmd('strikeThrough')"><svg
                                        ...
                                        <!-- <i class="fas fa-strikethrough"></i> Font Awesome fontawesome.com --></button>
                                    <button onclick="execCmd('justifyLeft')"><svg class="svg-inline--fa fa-align-left"
                                        ...
                                        <!-- <i class="fas fa-align-left"></i> Font Awesome fontawesome.com --></button>
                                    <button onclick="execCmd('justifyCenter')"><svg
                                        ...
                                        <!-- <i class="fas fa-align-center"></i> Font Awesome fontawesome.com --></button>
                                    <button onclick="execCmd('justifyRight')"><svg class="svg-inline--fa fa-align-right"
                                            aria-hidden="true" focusable="false" data-prefix="fas"
                                            data-icon="align-right" role="img" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 448 512" data-fa-i2svg="">
                                            <path fill="currentColor"
                                                d="M416 96H192C174.3 96 160 81.67 160 64C160 46.33 174.3 32 192 32H416C433.7 32 448 46.33 448 64C448 81.67 433.7 96 416 96zM416 352H192C174.3 352 160 337.7 160 320C160 302.3 174.3 288 192 288H416C433.7 288 448 302.3 448 320C448 337.7 433.7 352 416 352zM0 192C0 174.3 14.33 160 32 160H416C433.7 160 448 174.3 448 192C448 209.7 433.7 224 416 224H32C14.33 224 0 209.7 0 192zM416 480H32C14.33 480 0 465.7 0 448C0 430.3 14.33 416 32 416H416C433.7 416 448 430.3 448 448C448 465.7 433.7 480 416 480z">
                                            </path>
                                        </svg>
                                        <!-- <i class="fas fa-align-right"></i> Font Awesome fontawesome.com --></button>
                                    <button onclick="execCmd('justifyFull')"><svg
                                        ...
                                        <!-- <i class="fas fa-align-justify"></i> Font Awesome fontawesome.com --></button>
                                    <button onclick="execCmd('insertUnorderedList')"><svg
                                        ...
                                        <!-- <i class="fas fa-list-ul"></i> Font Awesome fontawesome.com --></button>
                                    <button onclick="execCmd('insertOrderedList')"><svg
                                        ...
                                        <!-- <i class="fas fa-list-ol"></i> Font Awesome fontawesome.com --></button>
                                    <button onclick="execCmd('createLink', prompt('Enter the URL:', 'http://'))"><svg
                                    ...
                                    <button onclick="execCmd('unlink')"><svg class="svg-inline--fa fa-link-slash"
                                            aria-hidden="true" focusable="false" data-prefix="fas"
                                            data-icon="link-slash" role="img" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <!-- <i class="fas fa-unlink"></i> Font Awesome fontawesome.com --></button>
                                    <button onclick="insertImage()"><svg class="svg-inline--fa fa-image"
                                        ...
                                        <!-- <i class="fas fa-image"></i> Font Awesome fontawesome.com --></button>
                                    <button onclick="insertTable()"><svg class="svg-inline--fa fa-table"
                                        ...
                                        <!-- <i class="fas fa-table"></i> Font Awesome fontawesome.com --></button>
                                    <button onclick="toggleHTML()">Toggle HTML</button>
                                </div>
                                <textarea id="editor" name="mail_content" class="form-control" contenteditable="true"
                                    style="height:160px;">
                        ...
                        <div class="col-md-10">
                            <div class="form-check" id="is_automatic_action_check" style="display:none;">
                                ...
                                <label class="form-check-label" for="exampleCheckbox1">Automatic action <svg
                                    ...
                                    <!-- <i class="fa-solid fa-retweet"></i> Font Awesome fontawesome.com --></label>
                            </div>
                            <div class="form-check" style="display:none;">
                                <input class="form-check-input" type="checkbox" id="exampleCheckbox2">
                                <label class="form-check-label" for="exampleCheckbox2">Internal interactive email <svg
                                        class="svg-inline--fa fa-up-right-from-square" aria-hidden="true"
                                    ...
                                    <!-- <i class="fa-solid fa-up-right-from-square"></i> Font Awesome fontawesome.com --></label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mt-1">
                            <div class="row justify-content-end">
                                <div class="col-md-4">
                                    <button class="btn btn-primary w-100"><svg class="svg-inline--fa fa-eye"
            ...
            <div class="text-center mt-1">
                <button type="submit" class="btn btn-success"><svg class="svg-inline--fa fa-plus" aria-hidden="true"
                        focusable="false" data-prefix="fas" data-icon="plus" role="img"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                        <path fill="currentColor"
                            d="M432 256c0 17.69-14.33 32.01-32 32.01H256v144c0 17.69-14.33 31.99-32 31.99s-32-14.3-32-31.99v-144H48c-17.67 0-32-14.32-32-32.01s14.33-31.99 32-31.99H192v-144c0-17.69 14.33-32.01 32-32.01s32 14.32 32 32.01v144h144C417.7 224 432 238.3 432 256z">
                        </path>
                    </svg><!-- <i class="fa-solid fa-plus"></i> Font Awesome fontawesome.com --> Add</button>
            </div>
        </div>
    </form>
</div>
...
<div class="scenarios-and-setting-buttons d-flex">
    <div class="container-fluid">
        <div class="col-6">
            ...
            <button id="btnone" onclick="secOneOpeen()" class="scenarios-active m-3" style="padding: 5px 10px ;">{{
                __('collection scenarios') }}</button>
...
<section class="sections-1 " id="sec-1">
                ...
                <div class="row"
                    ...
                    <div class="col-lg-8 col-sm-12 col-md-12">
                            ...
                            <div id="create-group-div-{{ $collection->id }}"
                                ...
                                <div class="bg-white m-auto p-3 shadow-sm position-relative"
                                    ...
                                    <div class="my-2">
                                        ...
                                        <div class="col-2">
                                            <label for="inputname18" style="width: 120px;">{{ __('Action Name') }}*
                                                :</label>
                                        </div>
                                        <div class="col-10">
                                            <div class="input-group">
                                                <input type="text" name="action_n" class="form-control" id="inputname18"
                                                    style="width: 355px;">

                                            </div>
                                        </div>
                                        <div class="col-2" style="margin-top: 15px;">
                                            <label for="inputname18" style="width: 120px;">{{ __('No. of days') }}*
                                                :</label>
                                        </div>
                                        <div class="col-10">
                                    ...
                                    <div class="text-center mt-5">
                                        <button class="btn btn-success"><i class="fa-solid fa-plus"></i>{{ __('Add')
                                            }}</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="content-text-2">
                            <ul class="d-flex">
                                <span>@</span>
                                <li><a href="#" onclick="showEditActionDiv({{$ActionScenario->id}})">{{
                                        $ActionScenario->action_name }}</a>
                                </li>
                        ...
                        <div class="position-fixed edit-action-div-{{$ActionScenario->id}} pop-up d-none w-75 pt-4 pe-4"
                            style="position: fixed;
                                ...
                                overflow-y: scroll;
                                overflow-x: hidden;">
                            <form id="myForm" action="{{ route('collection.update',$ActionScenario->id) }}"
                                method="POST">
                                @csrf
                                <input type="hidden" id="collection_scenario_id" name="collection_scenario_id"
                                    class="form-control" style="width: 355px;" value="{{$ActionScenario->id}}">
    ...
    height: 400px;">
                                            <select class="form-select" id="inputname19">
                                                <option value="" selected="">Do you want to copy the content of an
                                                    existing action?</option>
                                                <option value=""></option>
                                                <option value="">Clients publics (FR) / Courrier avec accusé réception
                                                    (Dunning letter - Français)</option>
                                                <option value="">Clients risqués (FR) / Courrier avec accusé réception
                                                    (Dunning letter - Français)</option>
                                                <option value="">Key accounts scenario (EN) / Reminder by post mail with
                                                    acknowledge of receipt (Dunning letter)</option>
                                                <option value="">Risky clients (EN) / Formal notice (Dunning letter)
                                                </option>
                                                <option value="">Risky clients (EN) / Reminder by post mail with
                                                    acknowledge of receipt (Dunning letter)</option>
                                                <option value="">Clients risqués (FR) / Courrier de mise en demeure
                                                    (Dunning letter via ERM - Français)</option>
                                                <option value="">Scénario de relance standard / Courrier de mise en
                                                    demeure (Dunning letter via ERM - Français)</option>
                                                <option value="">Standard Collection Scenario / Letter of formal notice
                                                    (Dunning letter via ERM)</option>
                                            </select>
                                            <div class="row">
                                                ...
                                                <!--l-3-->
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control clear-1" id="mail_subject"
                                                        name="mail_subject" value="{{$ActionScenario->mail_subject}}">
                                                </div>
                                                <!--r-3-->
                                                <div class="col-md-2">
                                                    <h4>Message :</h4>
                                                    <p style="color: rgb(172, 169, 169); text-align: center;"><svg
                                                            class="svg-inline--fa fa-hashtag hash"
                                                            style="height:30px;font-size:none;" aria-hidden="true"
                                                        ...
                                                        <!-- <i class="fa-solid fa-hashtag hash mb-4"></i> Font Awesome fontawesome.com --><br>
                                                        <a href="#" style="font-size:10px;">Incorporate dynamic content
                                                            in your letters with #Hashtag</a>
                                                    </p>
                                                </div>
                                                <!--l-4-->
                                                <div class="col-md-10">
                                                    <div class="editor-container">
                                                        <div class="toolbar">
                                                            <button onclick="execCmd('bold')"><svg
                                                                    class="svg-inline--fa fa-bold" aria-hidden="true"
                                                                    focusable="false" data-prefix="fas" data-icon="bold"
                                                                    role="img" xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <button onclick="execCmd('underline')"><svg
                                                                    class="svg-inline--fa fa-underline"
                                                                ...
                                                                <!-- <i class="fas fa-underline"></i> Font Awesome fontawesome.com --></button>
                                                            <button onclick="execCmd('strikeThrough')"><svg
                                                                    class="svg-inline--fa fa-strikethrough"
                                                                    aria-hidden="true" focusable="false"
                                                                    data-prefix="fas" data-icon="strikethrough"
                                                                    role="img" xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <button onclick="execCmd('justifyLeft')"><svg
                                                                ...
                                                                <!-- <i class="fas fa-align-left"></i> Font Awesome fontawesome.com --></button>
                                                            <button onclick="execCmd('justifyCenter')"><svg
                                                                    class="svg-inline--fa fa-align-center"
                                                                    aria-hidden="true" focusable="false"
                                                                    data-prefix="fas" data-icon="align-center"
                                                                    role="img" xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 448 512" data-fa-i2svg="">
                                                                    <path fill="currentColor"
                                                                        d="M320 96H128C110.3 96 96 81.67 96 64C96 46.33 110.3 32 128 32H320C337.7 32 352 46.33 352 64C352 81.67 337.7 96 320 96zM416 224H32C14.33 224 0 209.7 0 192C0 174.3 14.33 160 32 160H416C433.7 160 448 174.3 448 192C448 209.7 433.7 224 416 224zM0 448C0 430.3 14.33 416 32 416H416C433.7 416 448 430.3 448 448C448 465.7 433.7 480 416 480H32C14.33 480 0 465.7 0 448zM320 352H128C110.3 352 96 337.7 96 320C96 302.3 110.3 288 128 288H320C337.7 288 352 302.3 352 320C352 337.7 337.7 352 320 352z">
                                                            ...
                                                            <button onclick="execCmd('justifyRight')"><svg
                                                                    class="svg-inline--fa fa-align-right"
                                                                    aria-hidden="true" focusable="false"
                                                                ...
                                                                <!-- <i class="fas fa-align-right"></i> Font Awesome fontawesome.com --></button>
                                                            <button onclick="execCmd('justifyFull')"><svg
                                                                    class="svg-inline--fa fa-align-justify"
                                                                    aria-hidden="true" focusable="false"
                                                                    data-prefix="fas" data-icon="align-justify"
                                                                    role="img" xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 448 512" data-fa-i2svg="">
                                                                    <path fill="currentColor"
                                                                        d="M416 96H32C14.33 96 0 81.67 0 64C0 46.33 14.33 32 32 32H416C433.7 32 448 46.33 448 64C448 81.67 433.7 96 416 96zM416 352H32C14.33 352 0 337.7 0 320C0 302.3 14.33 288 32 288H416C433.7 288 448 302.3 448 320C448 337.7 433.7 352 416 352zM0 192C0 174.3 14.33 160 32 160H416C433.7 160 448 174.3 448 192C448 209.7 433.7 224 416 224H32C14.33 224 0 209.7 0 192zM416 480H32C14.33 480 0 465.7 0 448C0 430.3 14.33 416 32 416H416C433.7 416 448 430.3 448 448C448 465.7 433.7 480 416 480z">
                                                            ...
                                                            <button
                                                                ...
                                                                <!-- <i class="fas fa-link"></i> Font Awesome fontawesome.com --></button>
                                                            <button onclick="execCmd('unlink')"><svg
                                                                    class="svg-inline--fa fa-link-slash"
                                                                    aria-hidden="true" focusable="false"
                                                                ...
                                                                <!-- <i class="fas fa-unlink"></i> Font Awesome fontawesome.com --></button>
                                                            <button onclick="insertImage()"><svg
                                                                    class="svg-inline--fa fa-image" aria-hidden="true"
                                                                    focusable="false" data-prefix="fas"
                                                                ...
                                                                <!-- <i class="fas fa-image"></i> Font Awesome fontawesome.com --></button>
                                                            <button onclick="insertTable()"><svg
                                                                    class="svg-inline--fa fa-table" aria-hidden="true"
                                                                    focusable="false" data-prefix="fas"
                                                        ...
                                                        <textarea id="editor" name="mail_content"
                                                            class="form-control clear-2" contenteditable="true"
                                                            style="height:150px;">
                    {{$ActionScenario->mail_content}}
                                                ...
                                                <div class="col-md-10">
                                                    <select id="language" name="language" class="form-select"
                                                        aria-label="Default select example">
                                                        <option value="br" @if($ActionScenario->language == 'br')
                                                            selected @endif>Brazilian</option>
                                                        <option value="ar" @if($ActionScenario->language == 'ar')
                                                            selected @endif>Arabic</option>
                                                        <option value="ch" @if($ActionScenario->language == 'ch')
                                                            selected @endif>Chinese (Simplified)</option>
                                                        <option value="de" @if($ActionScenario->language == 'de')
                                                            selected @endif>Deutsch</option>
                                                        <option value="du" @if($ActionScenario->language == 'du')
                                                            selected @endif>Dutch</option>
                                                        <option value="en" @if($ActionScenario->language == 'en')
                                                            selected @endif>English</option>
                                                        <option value="es" @if($ActionScenario->language == 'es')
                                                            selected @endif>Español</option>
                                                        <option value="fr" @if($ActionScenario->language == 'fr')
                                                            selected @endif>Français</option>
                                                        <option value="it" @if($ActionScenario->language == 'it')
                                                            selected @endif>Italiano</option>
                                                        <option value="ja" @if($ActionScenario->language == 'ja')
                                                            selected @endif>Japanese</option>
                                                        <option value="po" @if($ActionScenario->language == 'po')
                                                            selected @endif>Polski</option>
                                                        <option value="por" @if($ActionScenario->language == 'por')
                                                            selected @endif>Português</option>
                                                        <option value="ro" @if($ActionScenario->language == 'ro')
                                                            selected @endif>Romanian</option>
                                                        <option value="tu" @if($ActionScenario->language == 'tu')
                                                            selected @endif>Turkish</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-2"></div>
                                                <div class="col-md-10">
                                                    @if($ActionScenario->action_type == 5 ||
                                                    $ActionScenario->action_type == 7)
                                                    <div class="form-check" id="is_automatic_action_check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="is_automatic_action" name="is_automatic_action"
                                                            value="1" @if($ActionScenario->is_automatic_action == 1)
                                                        checked @endif>
                                                        <label class="form-check-label" for="exampleCheckbox1">Automatic
                                                            action <svg class="svg-inline--fa fa-retweet"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="retweet" role="img"
                                                    ...
                                                    <div class="form-check" style="display:none;">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="exampleCheckbox2">
                                                        <label class="form-check-label" for="exampleCheckbox2">Internal
                                                            interactive email <svg
                                                    ...
                                                    <div class="row justify-content-end">
                                                        <div class="col-md-4">
                                                            <button class="btn btn-primary w-100"><svg
                                                                ...
                                                                <!-- <i class="fa-solid fa-eye"></i> Font Awesome fontawesome.com -->
                                                                Dunning letter preview</button>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="editor-container mb-1">
                        <div class="toolbar">
                            <button onclick="execCmd('bold')"><svg class="svg-inline--fa fa-bold" aria-hidden="true"
                                    focusable="false" data-prefix="fas" data-icon="bold" role="img"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                                    <path fill="currentColor"
                                        d="M321.1 242.4C340.1 220.1 352 191.6 352 160c0-70.59-57.42-128-128-128L32 32.01c-17.67 0-32 14.31-32 32s14.33 32 32 32h16v320H32c-17.67 0-32 14.31-32 32s14.33 32 32 32h224c70.58 0 128-57.41 128-128C384 305.3 358.6 264.8 321.1 242.4zM112 96.01H224c35.3 0 64 28.72 64 64s-28.7 64-64 64H112V96.01zM256 416H112v-128H256c35.3 0 64 28.71 64 63.1S291.3 416 256 416z">
                                    </path>
                                </svg><!-- <i class="fas fa-bold"></i> Font Awesome fontawesome.com --></button>
                            <button onclick="execCmd('italic')"><svg class="svg-inline--fa fa-italic" aria-hidden="true"
                                    focusable="false" data-prefix="fas" data-icon="italic" role="img"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                                    <path fill="currentColor"
                                        d="M384 64.01c0 17.69-14.31 32-32 32h-58.67l-133.3 320H224c17.69 0 32 14.31 32 32s-14.31 32-32 32H32c-17.69 0-32-14.31-32-32s14.31-32 32-32h58.67l133.3-320H160c-17.69 0-32-14.31-32-32s14.31-32 32-32h192C369.7 32.01 384 46.33 384 64.01z">
                                    </path>
                            ...
                            <button onclick="execCmd('strikeThrough')"><svg class="svg-inline--fa fa-strikethrough"
                                    aria-hidden="true" focusable="false" data-prefix="fas" data-icon="strikethrough"
                                    role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                    data-fa-i2svg="">
                                    <path fill="currentColor"
                                        d="M332.2 319.9c17.22 12.17 22.33 26.51 18.61 48.21c-3.031 17.59-10.88 29.34-24.72 36.99c-35.44 19.75-108.5 11.96-186-19.68c-16.34-6.686-35.03 1.156-41.72 17.53s1.188 35.05 17.53 41.71c31.75 12.93 95.69 35.37 157.6 35.37c29.62 0 58.81-5.156 83.72-18.96c30.81-17.09 50.44-45.46 56.72-82.11c3.998-23.27 2.168-42.58-3.488-59.05H332.2zM488 239.9l-176.5-.0309c-15.85-5.613-31.83-10.34-46.7-14.62c-85.47-24.62-110.9-39.05-103.7-81.33c2.5-14.53 10.16-25.96 22.72-34.03c20.47-13.15 64.06-23.84 155.4 .3438c17.09 4.531 34.59-5.654 39.13-22.74c4.531-17.09-5.656-34.59-22.75-39.12c-91.31-24.18-160.7-21.62-206.3 7.654C121.8 73.72 103.6 101.1 98.09 133.1C89.26 184.5 107.9 217.3 137.2 239.9L24 239.9c-13.25 0-24 10.75-24 23.1c0 13.25 10.75 23.1 24 23.1h464c13.25 0 24-10.75 24-23.1C512 250.7 501.3 239.9 488 239.9z">
                                ...
                                <!-- <i class="fas fa-strikethrough"></i> Font Awesome fontawesome.com --></button>
                            <button onclick="execCmd('justifyLeft')"><svg class="svg-inline--fa fa-align-left"
                                    aria-hidden="true" focusable="false" data-prefix="fas" data-icon="align-left"
                                    role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                    data-fa-i2svg="">
                                    <path fill="currentColor"
                                        d="M256 96H32C14.33 96 0 81.67 0 64C0 46.33 14.33 32 32 32H256C273.7 32 288 46.33 288 64C288 81.67 273.7 96 256 96zM256 352H32C14.33 352 0 337.7 0 320C0 302.3 14.33 288 32 288H256C273.7 288 288 302.3 288 320C288 337.7 273.7 352 256 352zM0 192C0 174.3 14.33 160 32 160H416C433.7 160 448 174.3 448 192C448 209.7 433.7 224 416 224H32C14.33 224 0 209.7 0 192zM416 480H32C14.33 480 0 465.7 0 448C0 430.3 14.33 416 32 416H416C433.7 416 448 430.3 448 448C448 465.7 433.7 480 416 480z">
                            ...
                            <button onclick="execCmd('justifyCenter')"><svg class="svg-inline--fa fa-align-center"
                                    aria-hidden="true" focusable="false" data-prefix="fas" data-icon="align-center"
                                    role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                    data-fa-i2svg="">
                                    <path fill="currentColor"
                                        d="M320 96H128C110.3 96 96 81.67 96 64C96 46.33 110.3 32 128 32H320C337.7 32 352 46.33 352 64C352 81.67 337.7 96 320 96zM416 224H32C14.33 224 0 209.7 0 192C0 174.3 14.33 160 32 160H416C433.7 160 448 174.3 448 192C448 209.7 433.7 224 416 224zM0 448C0 430.3 14.33 416 32 416H416C433.7 416 448 430.3 448 448C448 465.7 433.7 480 416 480H32C14.33 480 0 465.7 0 448zM320 352H128C110.3 352 96 337.7 96 320C96 302.3 110.3 288 128 288H320C337.7 288 352 302.3 352 320C352 337.7 337.7 352 320 352z">
                            ...
                            <button onclick="execCmd('justifyRight')"><svg class="svg-inline--fa fa-align-right"
                                    aria-hidden="true" focusable="false" data-prefix="fas" data-icon="align-right"
                                    role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                    data-fa-i2svg="">
                                    <path fill="currentColor"
                                        d="M416 96H192C174.3 96 160 81.67 160 64C160 46.33 174.3 32 192 32H416C433.7 32 448 46.33 448 64C448 81.67 433.7 96 416 96zM416 352H192C174.3 352 160 337.7 160 320C160 302.3 174.3 288 192 288H416C433.7 288 448 302.3 448 320C448 337.7 433.7 352 416 352zM0 192C0 174.3 14.33 160 32 160H416C433.7 160 448 174.3 448 192C448 209.7 433.7 224 416 224H32C14.33 224 0 209.7 0 192zM416 480H32C14.33 480 0 465.7 0 448C0 430.3 14.33 416 32 416H416C433.7 416 448 430.3 448 448C448 465.7 433.7 480 416 480z">
                            ...
                            <button onclick="execCmd('justifyFull')"><svg class="svg-inline--fa fa-align-justify"
                                    aria-hidden="true" focusable="false" data-prefix="fas" data-icon="align-justify"
                                    role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                    data-fa-i2svg="">
                                    <path fill="currentColor"
                                        d="M416 96H32C14.33 96 0 81.67 0 64C0 46.33 14.33 32 32 32H416C433.7 32 448 46.33 448 64C448 81.67 433.7 96 416 96zM416 352H32C14.33 352 0 337.7 0 320C0 302.3 14.33 288 32 288H416C433.7 288 448 302.3 448 320C448 337.7 433.7 352 416 352zM0 192C0 174.3 14.33 160 32 160H416C433.7 160 448 174.3 448 192C448 209.7 433.7 224 416 224H32C14.33 224 0 209.7 0 192zM416 480H32C14.33 480 0 465.7 0 448C0 430.3 14.33 416 32 416H416C433.7 416 448 430.3 448 448C448 465.7 433.7 480 416 480z">
                                ...
                                <!-- <i class="fas fa-align-justify"></i> Font Awesome fontawesome.com --></button>
                            <button onclick="execCmd('insertUnorderedList')"><svg class="svg-inline--fa fa-list-ul"
                            ...
                            <button onclick="execCmd('insertOrderedList')"><svg class="svg-inline--fa fa-list-ol"
                            ...
                            <button onclick="execCmd('unlink')"><svg class="svg-inline--fa fa-link-slash"
                                    aria-hidden="true" focusable="false" data-prefix="fas" data-icon="link-slash"
                            ...
                            <button onclick="insertImage()"><svg class="svg-inline--fa fa-image" aria-hidden="true"
                            ...
                            <button onclick="insertTable()"><svg class="svg-inline--fa fa-table" aria-hidden="true"
