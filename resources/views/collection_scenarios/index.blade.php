...
@csrf
        ...
        <div class="bg-white m-auto p-4 shadow-sm position-relative" style="border-radius: 10px;">
          ...
          <div class="d-none" id="dunning-letter">
            <div class="modal-content w-100" style="overflow-x: hidden;
    overflow-y: scroll;
    height: 250px;">
                            ...
                            <div class="col-lg-8 col-sm-12 col-md-12">
                                ...
                                @foreach ($collection->ActionScenarios as $ActionScenario)
                                    <div class="content-text-2">
                                        <ul class="d-flex">
                                            <span>@</span>
                                            <li><a href="#" onclick="showAddActionDiv()">{{ $ActionScenario->action_name }}</a>
                                            </li>
