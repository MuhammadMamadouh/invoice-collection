...
<div class="header-risk">
  <h2 class="text-capitalize text-center mt-5 mb-2">Report Disputes  <a href="#"><i class="fa-solid fa-question bg-primary text-light p-1" style="border-radius: 50%;width: 15px;height: 15px;"></i></a></h2>
</div>
<div class="title-risk text-capitalize">
  <div class="container-fluid d-flex justify-content-between">
    <div class="d-flex">
      ...
      <button class="mt-1 p-2 text-capitalize border-primary" style="cursor: pointer;"><a href="#" class="text-decoration-none"><span><i class="fa-regular fa-square-check pe-2"></i></span>Resolution </a></button>
    </div>
</div>
          ...
          <div class="col-lg-8">
            ...
            <div class="d-flex justify-content-end">
              <i class="fa-solid fa-download text-secondary " style="font-size: 25px;"></i>
                ...
                <div class="chart-2">
                  <canvas id="myChart-14"  width="700" height="400"></canvas>
                </div>
          </div>
          <div class="col-lg-4">
...
<!--texts-->
   ...
   <script src="js/chart-14.js"></script>
