    ...
    <div class="container">
      <div class="row pb-5">
        ...
        <div class="col-lg-6" style="height:300px ;">
          ...
          <canvas id="myChart-20"  width="200" height="200"></canvas>
        </div>
      </div>
    </div>
    </div>
...
<div class="header-risk">
  <h2 class="text-capitalize text-center mt-5 mb-2">Cash receipts
...
<div class="title-risk text-capitalize">
  <div class="container-fluid">
    <button class="mt-1 text-capitalize border-primary"><span><i class="fa-solid fa-money-bill-1-wave pe-2"></i></span> Cash receipts</button>
          ...
          <div class="col-lg-8">
            <div class="weeaks d-flex justify-content-between mb-3 text-capitalize">
              ...
              <div class="d-flex justify-content-end">
                ...
                <div class="chart-2">
                  <canvas id="myChart-2"  width="700" height="300"></canvas>
                </div>
          </div>
          <div class="col-lg-4">
    ...
    <div>
      ...
      <div class="row mt-2 px-4 text-center">
        ...
        <div class="col hide">
           <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">February 2023</p>
          </div>
        ...
        <div class="col hide">
           <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">January 2022</p>
          </div>
...
<!--texts-->
   ...
   <script src="js/chart-20.js"></script>
