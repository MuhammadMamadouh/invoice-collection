    ...
    <section class="mt-2">
      <div class="container-fluid">
        <div class="row table-alerts-container">
          <div class="col-sm-4">
            <div class="d-flex all-alerts-container justify-content-between align-items-center p-2 bg-primary">
              <h6 class="text-light ms-2">All Alerts</h6>
              <h6 class="badge bg-danger me-2 mt-1">200</h6>
            </div>
            <div class="d-flex all-alerts-child-red mb-1 justify-content-between align-items-center p-2 " style="background-color: #006bff14" onclick="updateSelectedAlert(this)">
              <p class="ms-2 w-50" style="color:#777676 ;">Customer receivable above cridit limit</p>
              <h6 class="badge bg-danger me-2 mt-1">200</h6>
            </div>
            <div class="d-flex all-alerts-child-blue mb-1 justify-content-between align-items-center p-2 " style="background-color: #006bff14" onclick="updateSelectedAlert(this)">
              <p class="ms-2 w-50" style="color:#777676 ;">Customer receivable above cridit limit</p>
              <h6 class="badge bg-danger me-2 mt-1">200</h6>
            </div>
            <div class="d-flex all-alerts-child-blue mb-1 justify-content-between align-items-center p-2 " style="background-color: #006bff14" onclick="updateSelectedAlert(this)">
            ...
            <div class=" all-alerts-end p-2 bg-primary">
              <h6 class="text-light text-center"><a href="addCollectionAlert.html" class="text-light" style="text-decoration: none;"><i class="fa-solid fa-plus"></i> New alert</a></h6>
            </div>
          </div>
          <div class="col-sm-8">
            ...
            <div id="selectedAlert" class="d-flex d-none justify-content-between align-items-center mb-4">
              <p class="mt-1"></p>
              <a href="editCollectionAlert.html" class="btn btn-primary"><i class="fa-solid fa-pen"></i> Edit</a>
            </div>
          ...
          <p class="fw-bold">Business name</p>
            ...
            <div class="col-3 col-md-1 ">
              <div class="d-flex align-items-center justify-content-center gap-1 ">
          <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
          <p class="fw-bold">No.of alerts</p>
        </div>
        </div>
          ...
          <p class="fw-bold">Overdue +60d</p>
            ...
            <div
              ...
              <div class="row align-items-center pt-3" style="background-color: #006bff14">
                ...
                <div class="col-3 col-md-1 mb-3 alert-icon-container">
                  <i class="fa-solid fa-bell text-danger" style="font-size: 25px;"></i>
                  <span class="alert-counter">5</span>
                   <div class="alert-list">
                      <!-- List of alerts -->
                      <div class="alert-item"><a href="#">Alert:</a> Customer receivable above cridit limit</div>
                      <div class="alert-item"><a href="#">Alert:</a> Customer receivable above cridit limit</div>
                      <div class="alert-item"><a href="#">Alert:</a> Customer receivable above cridit limit</div>
                  </div>
                </div>
