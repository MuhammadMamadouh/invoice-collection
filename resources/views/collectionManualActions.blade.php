    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-3 col-md-4 col-sm-6">
          <a href="collectionManualActions.html" class="m-1 w-100 btn btn-primary  p-3">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <a href="collectionAlerts.html" class="m-1 w-100 btn btn-outline-primary p-3"><i class="fa-solid fa-bell"></i>
            My Alerts
  ...
  <section class="mt-2">
    <div class="container-fluid">
        ...
        <div class="row align-items-center pt-3" style="background-color: #006bff14">
          ...
          <div class="col">
            <div class="mouse-hovers d-flex justify-content-center">
              ...
              <span class="conttt">due date: sunday, may 2022 <br> / action 4 days after due date of <br> oldest invoice
              </span>
            </div>
          </div>
          <div class="col-md-2 col-5">
            <div class="btn openModalBtn btn-primary w-100 mb-3">
              @ E-mail
            </div>
          </div>
          <div class="col-2 hide">
            <p><a href="#" class="openModalBtn">Relance par email n°1</a></p>
          </div>
          <div class="col-2 hide">
            <p>12,916.00 €</p>
          </div>
          <div class="col-1 hide">
            ...
            <span class="conttt-2">payment profile < payeur correct / average payeur> <br> average days beyond items
                +28days (< 10days) </span>
          </div>
          <div class="col hide">
      ...
      <div class="text-md-start mx-md-5 text-center px-4 mb-2">
        <div class="thebtn-1 btn btn-primary px-2 m-1">
        ...
        <div class="thebtn-3 btn btn-primary px-2 m-1">
      ...
      <div class="text-center mb-4">
        <div class="btn btn-primary" style="border-radius: 20px;">Number of open items : 4505</div>
      </div>
      <div class="text-center mb-2">
        <div class="this-buttons">
          <div class="">
            <div class="btn-group">
              <button type="button" class="btn text-light"><span><i class="fa-solid fa-download"></i>&ensp;</span>Export
