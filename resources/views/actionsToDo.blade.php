...
<div class="position-fixed w-75 d-none complete-action-div " style="top:10% ;left: 50%;transform: translate(-50%);z-index: 12;">
  <div class="bg-white m-auto p-5 shadow-sm position-relative" style="border-radius: 10px;">
    <span class="btn btn-secondary position-absolute" onclick="hideCompleteAction()" style="border-radius:50%;top: -20px;right: -20px;"><i class="fa-solid fa-close"></i></span>
    <h2 class="text-center">Complete the action</h2>
    <p class="text-center mt-3">The next action will be scheduled in
      <select  id="inputname38">
...
<section class="mt-5">
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6"><a href="actionsToDo.html" class="m-1 w-100 btn btn-primary text-light p-3" id="actionButton"><i class="fa-solid fa-hand-point-right"></i> Action to do <span class="badge bg-danger">184</span></a></div>
    ...
    <div>
      <form class="row justify-content-center">
        <div class="form-group col-lg-3 col-md-4 col-sm-6">
          <select class="form-select m-2" aria-label="Default select example">
            <option value="" selected disabled>Customers only with :</option>
            <option value="1">Overdue</option>
            <option value="2">Receivable</option>
            <option value="3">Receivable = 0</option>
          </select>
        </div>
        <div class="form-group col-lg-3 col-md-4 col-sm-6">
          <select class="form-select m-2 w-100" aria-label="Default select example">
            <option selected disabled>Credit Limit vs Guarantees :</option>
            <option value="1">Credit Limit > Guarantees <br> (Insurer guarantee + Other guarantees + Temporary guarantee)</option>
            <option value="2">Credit Limit <= Guarantees <br> (Insurer guarantee + Other guarantees + Temporary guarantee)</option>
          </select>
        </div>
        <div class="form-group col-lg-3 col-md-4 col-sm-6">
          <select class="form-select m-2" aria-label="Default select example">
    ...
    <div class="mt-4">    
    <div class="width-responsive-50 m-auto mb-1">Period displayed :</div>
    <div class="text-center mb-1">Today</div>
    <div class="parent-input d-flex justify-content-center">
        <input type="range" min="-24" value="-24" max="0" class="bg-primary" id="first-range" onchange="submitValues()"/>
        <span class="rangeSperade"></span>
        <input type="range" min="0" value="24" max="24" class="bg-primary second-range" id="second-range" onchange="submitValues()"/>
    </div>
     <div class="d-flex justify-content-center gap-5">
      <div class="step-container">
        <div class="steps text-center" id="step1"></div> <!-- Step displayed below the first input -->
      </div>
      <div class="step-container">
        <div class="steps text-center" id="step2"></div> <!-- Step displayed below the second input -->
      </div>
    </div>
    <div class="text-end m-auto width-responsive-50 d-none" id="range-submit"><div class="btn btn-primary ">Submit</div></div>
</div>
  </div>
</section>
<section class="mt-2">
  <div class="container-fluid">
    ...
    <div class="row mt-2 px-4 akign-items-center text-center">
      <div class=" col-1">
        <div class="form-check">
    ...
    <div class="text-center mb-3 table-container p-2 p-md-4 ">
      <div class="row align-items-center pt-3" style="background-color:#006BFF14;">
        ...
        <div class="col "><p class="fw-bold">13-5-2022</p></div>
        <div class="col-md-3 col-5">
          <div onclick="showHolap()" class="btn btn-primary w-100 mb-2"><i class="fa-solid fa-clock"></i>  &ensp; Credit limit review</div>
          <p>Ignore this action until 2202-05-13</p>
        </div>
        <div class="col-3 hide">
          <p class="m-0">Credit limit: 100,000.00 €</p>
          <p class="m-0">(Last modification of the credit limit: 2020-03-02)</p>
        </div>
        <div class="col-1 hide">
          <span class="onmouse-2"><i class="fa-solid fa-flag text-primary"></i></span>
          <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span>
        </div>
        <div class="col hide"><p class="fw-bold">1230504</p></div>
        <div class="col-1"><p class="fw-bold"><a href="#" onclick="showHolap()">Kokel</a></p></div>
        <div class="col-1"><p class="fw-bold">145368</p></div>
        <div class="col tavle-dropdown-icon" onclick="toggleFunction(this)"><i class="fa-solid fa-chevron-down"></i></div>
        <div class="hidden ms-2 d-none">
          <div class="d-flex bg-white">
            <p class="fw-bold">Description:</p>
            <p class="m-0">Credit limit: 100,000.00 €</p>
          ...
          <div class="d-flex bg-white"><p class="fw-bold">Flag: </p>
            <span class="onmouse-2"><i class="fa-solid fa-flag text-primary"></i></span>
            <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span>
          </div>
          <div class="d-flex bg-white"><p class="fw-bold">Company code:</p><p class="fw-bold">1230504</p></div>
        </div>
      </div>
      <div class="row align-items-center pt-3">
        <div class="col-1">
        ...
        <div class="col-1 hide">
          <span class="onmouse-2"><i class="fa-solid fa-flag text-danger"></i></span>
          <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
        <div class="col hide"><p class="fw-bold">1230504</p></div>
        <div class="col-1"><p class="fw-bold"><a href="#" onclick="showHolap()">Kokel</a></p></div>
        <div class="col-1"><p class="fw-bold">145368</p></div>
        <div class="col tavle-dropdown-icon" onclick="toggleFunction(this)"><i class="fa-solid fa-chevron-down"></i></div>
        <div class="hidden ms-2 d-none">
          ...
          <div class="d-flex bg-white"><p class="fw-bold">Flag: </p>          <span class="onmouse-2"><i class="fa-solid fa-flag text-danger"></i></span>
            <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
          <div class="d-flex bg-white"><p class="fw-bold">Company code:</p><p class="fw-bold">1230504</p></div>
        </div>
      </div>
      <div class="row align-items-center pt-3" style="background-color:#006BFF14;">
        ...
        <div class="col-1 hide">          <span class="onmouse-2"><i class="fa-solid fa-flag text-success"></i></span>
          <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
        <div class="col hide"><p class="fw-bold">1230504</p></div>
        <div class="col-1"><p class="fw-bold"><a href="#" onclick="showHolap()">Kokel</a></p></div>
        <div class="col-1"><p class="fw-bold">145368</p></div>
        ...
        <div class="hidden ms-2 d-none">
          ...
          <div class="d-flex bg-white"><p class="fw-bold">Flag: </p>         
             <span class="onmouse-2"><i class="fa-solid fa-flag text-success"></i></span>
            <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
          <div class="d-flex bg-white"><p class="fw-bold">Company code:</p><p class="fw-bold">1230504</p></div>
        </div>
      </div>
      <div class="row align-items-center pt-3">
        ...
        <div class="col-1 hide">          <span class="onmouse-2"><i class="fa-solid fa-flag text-secondary"></i></span>
          <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
        <div class="col hide"><p class="fw-bold">1230504</p></div>
        <div class="col-1"><p class="fw-bold"><a href="#" onclick="showHolap()">Kokel</a></p></div>
        <div class="col-1"><p class="fw-bold">145368</p></div>
        ...
        <div class="hidden ms-2 d-none">
          ...
          <div class="d-flex bg-white"><p class="fw-bold">Flag: </p>          <span class="onmouse-2"><i class="fa-solid fa-flag text-secondary"></i></span>
            <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
          <div class="d-flex bg-white"><p class="fw-bold">Company code:</p><p class="fw-bold">1230504</p></div>
        </div>
      </div>
      <div class="row align-items-center pt-3" style="background-color:#006BFF14;">
        ...
        <div class="col-1 hide">          <span class="onmouse-2"><i class="fa-solid fa-flag text-white"></i></span>
          <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
        <div class="col hide"><p class="fw-bold">1230504</p></div>
        <div class="col-1"><p class="fw-bold"><a href="#" onclick="showHolap()">Kokel</a></p></div>
        <div class="col-1"><p class="fw-bold">145368</p></div>
        ...
        <div class="hidden ms-2 d-none">
          ...
          <div class="d-flex bg-white"><p class="fw-bold">Flag: </p>          <span class="onmouse-2"><i class="fa-solid fa-flag text-white"></i></span>
            <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
          <div class="d-flex bg-white"><p class="fw-bold">Company code:</p><p class="fw-bold">1230504</p></div>
        </div>
      </div>
      <div class="row align-items-center pt-3">
        ...
        <div class="col-1 hide">          <span class="onmouse-2"><i class="fa-solid fa-flag text-dark"></i></span>
          <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
        <div class="col hide"><p class="fw-bold">1230504</p></div>
        <div class="col-1"><p class="fw-bold"><a href="#" onclick="showHolap()">Kokel</a></p></div>
        <div class="col-1"><p class="fw-bold">145368</p></div>
        ...
        <div class="hidden ms-2 d-none">
          ...
          <div class="d-flex bg-white"><p class="fw-bold">Flag: </p>          <span class="onmouse-2"><i class="fa-solid fa-flag text-dark"></i></span>
            <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
          <div class="d-flex bg-white"><p class="fw-bold">Company code:</p><p class="fw-bold">1230504</p></div>
        </div>
      </div>
      <div class="row align-items-center pt-3" style="background-color:#006BFF14;">
        ...
        <div class="col-1 hide">          <span class="onmouse-2"><i class="fa-solid fa-flag text-warning"></i></span>
          <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
        <div class="col hide"><p class="fw-bold">1230504</p></div>
        <div class="col-1"><p class="fw-bold"><a href="#" onclick="showHolap()">Kokel</a></p></div>
        <div class="col-1"><p class="fw-bold">145368</p></div>
        ...
        <div class="hidden ms-2 d-none">
          ...
          <div class="d-flex bg-white"><p class="fw-bold">Flag: </p>          <span class="onmouse-2"><i class="fa-solid fa-flag text-warning"></i></span>
            <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
          <div class="d-flex bg-white"><p class="fw-bold">Company code:</p><p class="fw-bold">1230504</p></div>
        </div>
      </div>
      <div class="row align-items-center pt-3">
        ...
        <div class="col-1 hide">          <span class="onmouse-2"><i class="fa-solid fa-flag text-info"></i></span>
          <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
        <div class="col hide"><p class="fw-bold">1230504</p></div>
        <div class="col-1"><p class="fw-bold"><a href="#" onclick="showHolap()">Kokel</a></p></div>
        <div class="col-1"><p class="fw-bold">145368</p></div>
        ...
        <div class="hidden ms-2 d-none">
          ...
          <div class="d-flex bg-white"><p class="fw-bold">Flag: </p>          <span class="onmouse-2"><i class="fa-solid fa-flag text-info"></i></span>
            <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
          <div class="d-flex bg-white"><p class="fw-bold">Company code:</p><p class="fw-bold">1230504</p></div>
        </div>
      </div>
      <div class="row align-items-center pt-3" style="background-color:#006BFF14;">
        ...
        <div class="col-1 hide">          <span class="onmouse-2"><i class="fa-solid fa-flag text-primary"></i></span>
          <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
        <div class="col hide"><p class="fw-bold">1230504</p></div>
        <div class="col-1"><p class="fw-bold"><a href="#" onclick="showHolap()">Kokel</a></p></div>
        <div class="col-1"><p class="fw-bold">145368</p></div>
        ...
        <div class="hidden ms-2 d-none">
          ...
          <div class="d-flex bg-white"><p class="fw-bold">Flag: </p>          <span class="onmouse-2"><i class="fa-solid fa-flag text-primary"></i></span>
            <span class="conttt-2">payment profile < payeur correct / average payeur >  <br> average days beyond items +28days (< 10days) </span></div>
          <div class="d-flex bg-white"><p class="fw-bold">Company code:</p><p class="fw-bold">1230504</p></div>
        </div>
      </div>
    ...
    <div class="text-md-start mx-md-5 text-center px-4 mb-2">
      <div class="btn text-light btn-primary px-2 m-1" onclick="showCompleteAction()"> <i class="fa-solid fa-check"></i>&ensp;Complete the action</div>
      <div class="thebtn-1 btn btn-primary position-relative x-2 m-1" onclick="showCalender()"> <i class="fa-solid fa-calendar"></i>&ensp;Update the action date
