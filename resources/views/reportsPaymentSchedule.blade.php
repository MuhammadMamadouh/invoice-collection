...
<!--new-Holap-->
  ...
  <section>
    <div class="container-fluid">
      <div>
        <h2 class="text-center my-4">Payment Schedule <a href="agingBalanceInformation.html"><i class="fa-solid fa-question bg-primary text-light p-1" style="border-radius: 50%;width: 22px;height: 22px;"></i></a></h2>
        <form class="row justify-content-center">
          <div class="form-group col-lg-3 col-md-4 col-sm-6">
            <select class="form-select border-primary m-2" onfocus='this.size=9;' onblur='this.size=1;'
          ...
          <div class=" col-lg-3 col-md-4 col-sm-6 text-center ">
            <button type="button" class="btn btn-primary m-2" onclick="toggleRows(this)"><i
                class="fa-solid fa-chevron-down" id="toggleIconDown" style="transition:all 0.6s ;"></i></button>
          </div>
        </form>
  ...
  <h3 class="mt-2 mb-2 text-center">Detail per client</h3>
  ...
  <section>
    <div class="tabel-payemnt-two text-center">
      <div class="container-fluid mt-5">
        <div class="table-responsive">
          <table class="table table-hover">
            <thead class="thead-dark text-center">
              <tr>
                <th class="top-elemnt">Company code</th>
                <th class="top-elemnt">Company / Business name</th>
                <th class="bg-tables">Total collectable <p class="text-black-50"> July 2024</p></th>
                <th class="bg-tables">Remains to collect <p class="text-black-50"> July 2024</p></th>
                <th class="bg-tables">Collection efficiency <p class="text-black-50"> July 2024</p></th>
                <th class="top-elemnt">Total receivable</th>
                <th class="top-elemnt">Overdue</th>
                <th>Current month <p class="text-black-50"> July 2024</p></th>
                <th>Month M+1 <p class="text-black-50">August 2024</p></th>
                <th>Month M+2 <p class="text-black-50"> September 2024</p></th>
                <th>Month M+3 <p class="text-black-50"> October 2024</p></th>
                <th>Month M+4 <p class="text-black-50"> November 2024</p></th>
              </tr>
            </thead>
            <tbody class="text-center">
              <tr class="bg-tabels-payemnt">
                <td><a href="#" onclick="showHolap()" class="d-flex justify-content-around"><span><i class="fa-solid fa-flag"></i></span>2912</a></td>
                <td><a href="#" onclick="showHolap()"> CENTRE HOSPITALIER</a></td>
                <td class="bg-tables">326 k€</td>
                <td class="bg-tables">324 k€</td>
                <td class="bg-tables">
                  1.7 %
                  <div class="progress">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: 5%;" aria-valuenow="54.8" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </td>
                <td>518 k€</td>
                <td>232 k€</td>
              ...
              <tr>
                <td><a href="#" onclick="showHolap()" class="d-flex justify-content-around"><span><i class="fa-solid fa-flag"></i></span>2912</a></td>
                <td><a href="#" onclick="showHolap()">OLEANO</a></td>
                <td class="bg-tables">251 k€</td>
                <td class="bg-tables">248 k€</td>
                <td class="bg-tables">
                  4 %
                  <div class="progress">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: 10%;" aria-valuenow="4" aria-valuemin="0" aria-valuemax="100"></div>
              ...
              <tr class="bg-tabels-payemnt">
                <td><a href="#" onclick="showHolap()" class="d-flex justify-content-around"><span><i class="fa-solid fa-flag"></i></span>2912</a></td>
                <td><a href="#" onclick="showHolap()">FERRARI</a></td>
                <td class="bg-tables">246 k€</td>
                <td class="bg-tables">242 k€</td>
                <td class="bg-tables">
                  1.9%
                  <div class="progress">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: 5% ; " aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </td>
                <td>330 k€</td>
                <td>180 k€</td>
              ...
              <tr>
                <td><a href="#" onclick="showHolap()" class="d-flex justify-content-around"><span class="green-flags"><i class="fa-solid fa-flag"></i></span>2912</a></td>
                <td><a href="#" onclick="showHolap()"> MCP SERVICES</a></td>
                <td class="bg-tables">230 k€</td>
                <td class="bg-tables">218 k€</td>
                <td class="bg-tables">
                  5%
                  <div class="progress">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: 5%;"  aria-valuenow="59.3" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </td>
                <td>424 k€</td>
                <td>205 k€</td>
              ...
              <tr class="bg-tabels-payemnt">
                <td><a href="#" onclick="showHolap()" class="d-flex justify-content-around"><span><i class="fa-solid fa-flag"></i></span>2912</a></td>
                <td><a href="#" onclick="showHolap()"> MAS- A.D.I.J</a></td>
                <td class="bg-tables">220 k€</td>
                <td class="bg-tables">216 k€</td>
                <td class="bg-tables">
                 1.7%
                  <div class="progress">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: 5%;" aria-valuenow="24.2" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </td>
                <td>341 k€</td>
                <td>182 k€</td>
