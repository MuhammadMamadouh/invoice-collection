    ...
    <section class="mt-5">
        <div class="container-fluid ">
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="{{ route('collection.manual.actions') }}" class="m-1 w-100 btn btn-outline-light text-dark p-3">
                        <svg class="svg-inline--fa fa-hand-point-right" aria-hidden="true" focusable="false" data-prefix="fas"
                            data-icon="hand-point-right" role="img" xmlns="http://www.w3.org/2000/svg"
                        ...
                        </svg><!-- <i class="fa-solid fa-hand-point-right"></i> Font Awesome fontawesome.com --> Manual
                        actions
                        <span class="badge bg-danger">200</span>
                    </a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="{{ route('collection.automatic.actions') }}"
                        class="m-1 w-100 btn btn-primary text-light p-3"><svg class="svg-inline--fa fa-arrows-rotate"
                            aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrows-rotate" role="img"
                        ...
                        </svg><!-- <i class="fa-solid fa-arrows-rotate"></i> Font Awesome fontawesome.com --> Automatic
                        actions
                        ...
                        </svg><!-- <i class="fa-solid fa-triangle-exclamation"></i> Font Awesome fontawesome.com -->
                        <span class="badge bg-danger">184</span></a>
                </div>
                <!--btns-->
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="collectionActionsHistoy.html" class="m-1 w-100 btn btn-outline-light text-dark p-3"><svg
                            class="svg-inline--fa fa-bars-staggered" aria-hidden="true" focusable="false" data-prefix="fas"
                            data-icon="bars-staggered" role="img" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512" data-fa-i2svg="">
                            <path fill="currentColor"
                        ...
                        </svg><!-- <i class="fa-solid fa-bars-staggered"></i> Font Awesome fontawesome.com -->
                        Actions history</a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <a href="collectionAlerts.html" class="m-1 w-100 btn btn-outline-light text-dark p-3"><svg
                            class="svg-inline--fa fa-bell" aria-hidden="true" focusable="false" data-prefix="fas"
                            data-icon="bell" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                            data-fa-i2svg="">
                            <path fill="currentColor"
                                d="M256 32V51.2C329 66.03 384 130.6 384 208V226.8C384 273.9 401.3 319.2 432.5 354.4L439.9 362.7C448.3 372.2 450.4 385.6 445.2 397.1C440 408.6 428.6 416 416 416H32C19.4 416 7.971 408.6 2.809 397.1C-2.353 385.6-.2883 372.2 8.084 362.7L15.5 354.4C46.74 319.2 64 273.9 64 226.8V208C64 130.6 118.1 66.03 192 51.2V32C192 14.33 206.3 0 224 0C241.7 0 256 14.33 256 32H256zM224 512C207 512 190.7 505.3 178.7 493.3C166.7 481.3 160 464.1 160 448H288C288 464.1 281.3 481.3 269.3 493.3C257.3 505.3 240.1 512 224 512z">
                            </path>
                        </svg><!-- <i class="fa-solid fa-bell"></i> Font Awesome fontawesome.com -->
                        My Alerts
            ...
            <div>
                <form class="row justify-content-center">
                    <div class="col-lg-1 col-md-2 col-sm-3 dropdown">
                        <a class="dropdown-toggle text-primary form-control m-2" href="#" id="reportsDropdown"
                            role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <svg class="svg-inline--fa fa-signal" aria-hidden="true" focusable="false" data-prefix="fas"
                                data-icon="signal" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
                                data-fa-i2svg="">
                                <path fill="currentColor"
                            ...
                            </svg><!-- <i class="fa-solid fa-signal"></i> Font Awesome fontawesome.com -->
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="reportsDropdown">
                            <li><a class="dropdown-item text-primary" href="#" onclick="showCharts1()"><svg
                                        class="svg-inline--fa fa-hand-point-right" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="hand-point-right" role="img"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                        <path fill="currentColor"
                                            d="M224 320c0 17.69 14.33 32 32 32h64c17.67 0 32-14.31 32-32s-14.33-32-32-32h-64C238.3 288 224 302.3 224 320zM267.6 256H352c17.67 0 32-14.31 32-32s-14.33-32-32-32h-80v40C272 240.5 270.3 248.5 267.6 256zM272 160H480c17.67 0 32-14.31 32-32s-14.33-32-32-32h-208.8C271.5 98.66 272 101.3 272 104V160zM320 416c0-17.69-14.33-32-32-32H224c-17.67 0-32 14.31-32 32s14.33 32 32 32h64C305.7 448 320 433.7 320 416zM202.1 355.8C196 345.6 192 333.3 192 320c0-5.766 1.08-11.24 2.51-16.55C157.4 300.6 128 269.9 128 232V159.1C128 151.2 135.2 144 143.1 144S160 151.2 159.1 159.1l0 69.72C159.1 245.2 171.3 271.1 200 271.1C222.1 271.1 240 254.1 240 232v-128C240 81.91 222.1 64 200 64H136.6C103.5 64 72.03 80 52.47 106.8L26.02 143.2C9.107 166.5 0 194.5 0 223.3V312C0 387.1 60.89 448 136 448h32.88C163.4 438.6 160 427.7 160 416C160 388.1 178 364.6 202.1 355.8z">
                                        </path>
                                    </svg><!-- <i class="fa-solid fa-hand-point-right"></i> Font Awesome fontawesome.com -->Actions
                                    to do</a></li>
                            <li><a class="dropdown-item text-primary" href="#" onclick="showCharts2()"><svg
                                        class="svg-inline--fa fa-thumbs-up" aria-hidden="true" focusable="false"
                                    ...
                                    </svg><!-- <i class="fa-solid fa-thumbs-up"></i> Font Awesome fontawesome.com -->
                                    Actions done</a>
                            </li>
                            <li><a class="dropdown-item text-primary" href="#" onclick="showCharts3()"><svg
                                        class="svg-inline--fa fa-clock-rotate-left" aria-hidden="true" focusable="false"
                    ...
                    <div class="col-md-2 col-sm-3 text-center">
                        <button type="button" class="btn btn-primary m-2" onclick="toggleRows(this)">
                            <svg class="svg-inline--fa fa-chevron-down" id="toggleIconDown" style="transition: all 0.6s;"
                            ...
                            </svg><!-- <i class="fa-solid fa-chevron-down" id="toggleIconDown" style="transition: all 0.6s"></i> Font Awesome fontawesome.com -->
                        </button>
                    </div>
                </form>
            ...
            <div class="row p-3 bg-light d-none collection-charts-1">
                <div class="col-lg-3">
                    <h6><svg class="svg-inline--fa fa-hand-point-right me-2" aria-hidden="true" focusable="false"
                            data-prefix="fas" data-icon="hand-point-right" role="img"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                            <path fill="currentColor"
                                d="M224 320c0 17.69 14.33 32 32 32h64c17.67 0 32-14.31 32-32s-14.33-32-32-32h-64C238.3 288 224 302.3 224 320zM267.6 256H352c17.67 0 32-14.31 32-32s-14.33-32-32-32h-80v40C272 240.5 270.3 248.5 267.6 256zM272 160H480c17.67 0 32-14.31 32-32s-14.33-32-32-32h-208.8C271.5 98.66 272 101.3 272 104V160zM320 416c0-17.69-14.33-32-32-32H224c-17.67 0-32 14.31-32 32s14.33 32 32 32h64C305.7 448 320 433.7 320 416zM202.1 355.8C196 345.6 192 333.3 192 320c0-5.766 1.08-11.24 2.51-16.55C157.4 300.6 128 269.9 128 232V159.1C128 151.2 135.2 144 143.1 144S160 151.2 159.1 159.1l0 69.72C159.1 245.2 171.3 271.1 200 271.1C222.1 271.1 240 254.1 240 232v-128C240 81.91 222.1 64 200 64H136.6C103.5 64 72.03 80 52.47 106.8L26.02 143.2C9.107 166.5 0 194.5 0 223.3V312C0 387.1 60.89 448 136 448h32.88C163.4 438.6 160 427.7 160 416C160 388.1 178 364.6 202.1 355.8z">
                            </path>
                        </svg><!-- <i class="fa-solid fa-hand-point-right me-2"></i> Font Awesome fontawesome.com -->Actions
                        to do</h6>
                    <div class="my-3">
                    ...
                    <div class="badge bg-secondary">564</div>
                    <p></p>
                    <ul class="list-unstyled text-secondary">
                        <li class="d-flex flex-wrap gap-2">
                            <div class="mt-1" style="width:15px ;height:15px;background-color:#0080A9;"></div> @ E-mail
                            : <span class="fw-bold">442</span>
                        </li>
                        <li class="d-flex flex-wrap gap-2">
                            <div class="mt-1" style="width:15px ;height:15px;background-color:#34D2D9;"></div> @ E-mail
                            (Automatic
                            action) : <span class="fw-bold">442</span>
                        </li>
                        <li class="d-flex flex-wrap gap-2">
                            <div class="mt-1" style="width:15px ;height:15px;background-color:#FF8F00;"></div> <svg
                                class="svg-inline--fa fa-phone mt-1" aria-hidden="true" focusable="false"
                            ...
                            </svg><!-- <i class="fa-solid fa-phone mt-1"></i> Font Awesome fontawesome.com --> Phone :
                            <span class="fw-bold">442</span>
                        </li>
                        <li class="d-flex flex-wrap gap-2">
                            <div class="mt-1" style="width:15px ;height:15px;background-color:#95C11B;"></div> <svg
                                class="svg-inline--fa fa-envelope mt-1" aria-hidden="true" focusable="false"
                                data-prefix="fas" data-icon="envelope" role="img" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512" data-fa-i2svg="">
                                <path fill="currentColor"
                                    d="M464 64C490.5 64 512 85.49 512 112C512 127.1 504.9 141.3 492.8 150.4L275.2 313.6C263.8 322.1 248.2 322.1 236.8 313.6L19.2 150.4C7.113 141.3 0 127.1 0 112C0 85.49 21.49 64 48 64H464zM217.6 339.2C240.4 356.3 271.6 356.3 294.4 339.2L512 176V384C512 419.3 483.3 448 448 448H64C28.65 448 0 419.3 0 384V176L217.6 339.2z">
                                </path>
                            </svg><!-- <i class="fa-solid fa-envelope mt-1"></i> Font Awesome fontawesome.com --> SMS :
                            <span class="fw-bold">442</span>
                        </li>
                        <li class="d-flex flex-wrap gap-2">
                            <div class="mt-1" style="width:15px ;height:15px;background-color:#F7EE00;"></div> <svg
                                class="svg-inline--fa fa-mobile mt-1" aria-hidden="true" focusable="false"
                            ...
                            </svg><!-- <i class="fa-solid fa-mobile mt-1"></i> Font Awesome fontawesome.com --> Dunning
                            letters : <span class="fw-bold">442</span>
                        </li>
                        <li class="d-flex flex-wrap gap-2">
                            <div class="mt-1" style="width:15px ;height:15px;background-color:#FF0081;"></div> <svg
                                class="svg-inline--fa fa-mobile mt-1" aria-hidden="true" focusable="false"
                                data-prefix="fas" data-icon="mobile" role="img" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 384 512" data-fa-i2svg="">
                                <path fill="currentColor"
                            ...
                            </svg><!-- <i class="fa-solid fa-mobile mt-1"></i> Font Awesome fontawesome.com --> Litigation
                            : <span class="fw-bold">442</span>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-9 bg-white" style="height:400px ;">
                    <canvas id="myChart-10" width="0" height="0"
            ...
            <div class="row p-3 bg-light d-none collection-charts-2">
                <div class="col-lg-3">
                    <h6><svg class="svg-inline--fa fa-hand-point-right me-2" aria-hidden="true" focusable="false"
                        ...
                        </svg><!-- <i class="fa-solid fa-hand-point-right me-2"></i> Font Awesome fontawesome.com -->Action
                        Done</h6>
                    <div class="my-3">
                        <span class="mb-5">By : </span>
                ...
                <div class="col-lg-9 bg-white" style="height:400px ;">
                    <canvas id="myChart-101" width="0" height="0"
                        style="display: block; box-sizing: border-box; height: 0px; width: 0px;"></canvas>
                </div>
            ...
            <div class="row p-3 bg-light d-none collection-charts-3">
                <div class="col-lg-3">
                    <h6><svg class="svg-inline--fa fa-clock me-2" aria-hidden="true" focusable="false" data-prefix="fas"
                        ...
                        </svg><!-- <i class="fa-solid fa-clock me-2"></i> Font Awesome fontawesome.com --> Actions forecast
                    </h6>
                    <div class="my-3">
                        <span class="mb-5">By : </span>
                ...
                <div class="col-lg-9 bg-white" style="height:400px ;">
                    <canvas id="myChart-102" width="0" height="0"
                        style="display: block; box-sizing: border-box; height: 0px; width: 0px;"></canvas>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row mt-2 px-4 text-center table-alerts-container">
                ...
                <div class="col">
                    <div class="d-flex align-items-center justify-content-center gap-1 ">
                        <svg class="svg-inline--fa fa-sort mb-3" style="cursor: pointer;" aria-hidden="true"
                        ...
                        </svg><!-- <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i> Font Awesome fontawesome.com -->
            ...
            <div class="text-center mb-3 table-container p-2 p-md-4">
                ...
                @php
                    ...
                    $client_code = null;
                    $tems_amount_overdue_exclude_disputes = $my_name = $my_phone = $my_email = $my_company_name = $actionSubject = $my_company_logo = null;
                @endphp
                @foreach ($items as $item)
                    @php
                        ...
                        $collectionScenarioActions = $collectionScenario->actions
                            ->where('is_automatic_action', 1)
                            ->toArray();
...
$my_company_logo = 'img/logo.png';
                    ...
                    <div class="row align-items-center pt-3" style="background-color: #006bff14">
                        ...
                        <div class="col">
                            <div class="mouse-hovers d-flex justify-content-center">
                                ...
                                <span class="conttt">due date: sunday, may 2022 <br> / action 4 days after due date of <br>
                                    oldest
                                    invoice
                                </span>
                            </div>
                        ...
                        <div class="col-md-2 col-5">
                            ...
                            @elseif($actionType->en_name == 'Dunning letter with AR (Acknowledgment of Receipt)')
                                <button class="btn text-light text-decoration-none btn-primary w-100 mb-3"
                                    onclick="showEditActionModal({{ $actionId }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                        class="svg-inline--fa fa-dunning-ar" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="envelope-check" role="img">
                                        <path fill="currentColor"
                                            d="M64 32h320c35.3 0 64 28.7 64 64v320c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96c0-35.3 28.7-64 64-64zm16 48v48h288V80H80zm288 416h-288V144h288v352zM160 368l-32-32 24-24 8 8 32-32 24 24-56 56zm56-56l-24-24 24-24 24 24-24 24zm224-64v-96c0-13.3-10.7-24-24-24H88c-13.3 0-24 10.7-24 24v96c0 13.3 10.7 24 24 24h256c13.3 0 24-10.7 24-24z" />
                                    </svg>
                                    {{ $actionType->en_name }}
                                </button>
                            ...
                            @elseif($actionType->en_name == 'Fax')
                                <button class="btn text-light text-decoration-none btn-primary w-100 mb-3"
                                    onclick="showEditActionModal({{ $actionId }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                        class="svg-inline--fa fa-fax" aria-hidden="true" focusable="false"
                                        data-prefix="fas" data-icon="fax" role="img">
                                        <path fill="currentColor"
                                            d="M464 80H368c-13.3 0-24 10.7-24 24v24H168v-24c0-13.3-10.7-24-24-24H48C21.5 80 0 101.5 0 128v352c0 26.5 21.5 48 48 48h416c26.5 0 48-21.5 48-48V128c0-26.5-21.5-48-48-48zM160 104h192v32H160v-32zm-8 64h208v48H152v-48zm-40 368H40c-8.8 0-16-7.2-16-16v-8h136v24zm416-24c0 8.8-7.2 16-16 16H376v-24h136v8zm0-56H40v-8h448v8zm0-40H40v-8h448v8zm0-40H40v-8h448v8zm0-40H40v-8h448v8zm0-40H40v-8h448v8zm0-40H40v-8h448v8zm0-40H40v-8h448v8z" />
                                    </svg>
                                    {{ $actionType->en_name }}
                                </button>
                            @elseif($actionType->en_name == 'SMS')
                                <button class="btn text-light text-decoration-none btn-primary w-100 mb-3"
                                    onclick="showEditActionModal({{ $actionId }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                        class="svg-inline--fa fa-sms" aria-hidden="true" focusable="false"
                        ...
                        <div class="col-2 hide">
                            <p><a href="#"
                                    onclick="showEditActionModal({{ $actionId }})">{{ $action }}</a></p>
                        </div>
                        <div class="col-2 hide">
                            <p>{{ $item->initial_amount_inc_tax }}</p>
                        </div>
                        <div class="col-1 hide">
                            <span class="onmouse-2"><svg class="svg-inline--fa fa-flag mb-2 text-primary"
                                    aria-hidden="true" focusable="false" data-prefix="fas" data-icon="flag"
                                    role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                    data-fa-i2svg="">
                                    <path fill="currentColor"
                                        d="M64 496C64 504.8 56.75 512 48 512h-32C7.25 512 0 504.8 0 496V32c0-17.75 14.25-32 32-32s32 14.25 32 32V496zM476.3 0c-6.365 0-13.01 1.35-19.34 4.233c-45.69 20.86-79.56 27.94-107.8 27.94c-59.96 0-94.81-31.86-163.9-31.87C160.9 .3055 131.6 4.867 96 15.75v350.5c32-9.984 59.87-14.1 84.85-14.1c73.63 0 124.9 31.78 198.6 31.78c31.91 0 68.02-5.971 111.1-23.09C504.1 355.9 512 344.4 512 332.1V30.73C512 11.1 495.3 0 476.3 0z">
                                    </path>
                                </svg><!-- <i class="fa-solid fa-flag mb-2 text-primary"></i> Font Awesome fontawesome.com --></span>
                        ...
                        <div class="col">
                            <p class="fw-bold"><a href="#" onclick="showHolap()">{{ $client->company_name }}</a>
                            </p>
                        </div>
                        ...
                        <div class="hidden ms-2 d-none">
                            ...
                            <div class="d-flex bg-white">
                                <p class="fw-bold">Flag:</p>
                                <span class="onmouse-2 "><svg class="svg-inline--fa fa-flag text-primary"
                                        aria-hidden="true" focusable="false" data-prefix="fas" data-icon="flag"
                                        role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                        data-fa-i2svg="">
                                        <path fill="currentColor"
                                    ...
                                    </svg><!-- <i class="fa-solid fa-flag text-primary"></i> Font Awesome fontawesome.com --></span>
            ...
            @foreach ($collectionScenarioActions as $collectionScenarioAction)
                ...
                @if (
                    $actionType->en_name == 'Dunning letter (Standard letter)' ||
                        $actionType->en_name == 'Dunning letter with AR (Acknowledgment of Receipt)' ||
                        $actionType->en_name == 'Dunning letter via ERM (Electronic Registered Mail)' ||
                        $actionType->en_name == 'E-mail' ||
                        $actionType->en_name == 'Fax' ||
                        $actionType->en_name == 'SMS')
                    <div id="myModal" class="modal-{{ $collectionScenarioAction['id'] }} d-none"
    ...
    background-color: rgba(0, 0, 0, 0.4);">
                        <div class="modal-content">
                            <div class="new-holab-1" id="hide-hoalp-1">
                                <div class="d-flex justify-content-end me-4 ">
                                    <a href="email.html" target="_blank"><svg
                                            class="svg-inline--fa fa-maximize text-primary p-2 bg-light"
                                            style="
          font-size: 15px;
          cursor: pointer;
          border-radius: 5px;"
                                            aria-hidden="true" focusable="false" data-prefix="fas" data-icon="maximize"
                                            role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                            data-fa-i2svg="">
                                            <path fill="currentColor"
                                        ...
                                        </svg><!-- <i class="fa-solid fa-maximize text-primary p-2 bg-light" style="
          font-size: 15px;
          cursor: pointer;
          border-radius: 5px;
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div style=" display: flex; flex-wrap: wrap;" class="my-2">
                                            <p> <input type="checkbox" class="form-check-input mx-2" id="copy"
                                                    name="copy">
                                        ...
                                        <select class="form-select" id="email_to0" name="email_to0">
                                            ...
                                            @foreach ($combined as $item)
                                                @if ($item instanceof \App\Models\Client)
                                                    <option value="mohamed@gmail.com">{{ $item->company_code }} /
                                                        {{ $item->company_name }}</option>
                                                @elseif($item instanceof \App\Models\User)
                                                    <option value="{{ $item->email }}">{{ $item->first_name }}
                                                        {{ '<' }}{{ $item->email }}{{ '>' }}
                                                        (Function : {{ $item->function }} / Role :
                                                        {{ $item->role->name }}) *** {{ $item->role->name }} ***</option>
                                                @endif
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-10 mt-2">
                                        <div style=" display: flex; flex-wrap: wrap;" class="my-2">
                                            <button type="button" class="text-primary mx-3" id="add_recipient"><span
                                                    class="mx-1"><svg class="svg-inline--fa fa-plus text-dark"
                                                    ...
                                                    </svg><!-- <i class="fa-solid fa-plus text-dark"></i> Font Awesome fontawesome.com --></span>Add
                                                anoter recipient</button>
                                            <a href="#" class="text-primary mx-3"
                                                style="text-decoration: none;"><span class="mx-1"><svg
                                                        class="svg-inline--fa fa-plus text-dark" aria-hidden="true"
                                    ...
                                    <div class="col-md-10 mt-2">
                                        <input type="text" class="form-control " id="mail_subject"
                                            value="{{ $collectionScenarioAction['mail_subject'] }}">
                                    </div><!--r-3-->
                                    <div class="col-md-2 mt-2">
                                        <h4 class="mb-5">Message :</h4>
                                        <p style="color: rgb(172, 169, 169); text-align: center;"><svg
                                                class="svg-inline--fa fa-hashtag hash mb-5" aria-hidden="true"
                                                focusable="false" data-prefix="fas" data-icon="hashtag"
                                                role="img" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512" data-fa-i2svg="">
                                                <path fill="currentColor"
                                            ...
                                            </svg><!-- <i class="fa-solid fa-hashtag hash mb-5"></i> Font Awesome fontawesome.com --><br>
                                            Lorem ipsum dolor sit amet.</p>
                                    </div><!--l-4-->
                                    <div class="col-md-10 mt-2">
                                        <div class="editor-container mb-1">
                                            <div class="toolbar">
                                                <button onclick="execCmd('bold')"><svg class="svg-inline--fa fa-bold"
                                                        aria-hidden="true" focusable="false" data-prefix="fas"
                                                        data-icon="bold" role="img"
                                                ...
                                                <button onclick="execCmd('italic')"><svg
                                                        class="svg-inline--fa fa-italic" aria-hidden="true"
                                                        focusable="false" data-prefix="fas" data-icon="italic"
                                                        role="img" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 384 512" data-fa-i2svg="">
                                                        <path fill="currentColor"
                                                ...
                                                <button onclick="execCmd('underline')"><svg
                                                        class="svg-inline--fa fa-underline" aria-hidden="true"
                                                        focusable="false" data-prefix="fas" data-icon="underline"
                                                        role="img" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 448 512" data-fa-i2svg="">
                                                        <path fill="currentColor"
                                                ...
                                                <button onclick="execCmd('strikeThrough')"><svg
                                                        class="svg-inline--fa fa-strikethrough" aria-hidden="true"
                                                        focusable="false" data-prefix="fas" data-icon="strikethrough"
                                                        role="img" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 512 512" data-fa-i2svg="">
                                                        <path fill="currentColor"
                                                ...
                                                <button onclick="execCmd('justifyLeft')"><svg
                                                        class="svg-inline--fa fa-align-left" aria-hidden="true"
                                                ...
                                                <button onclick="execCmd('justifyCenter')"><svg
                                                        class="svg-inline--fa fa-align-center" aria-hidden="true"
                                                        focusable="false" data-prefix="fas" data-icon="align-center"
                                                        role="img" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 448 512" data-fa-i2svg="">
                                                        <path fill="currentColor"
                                                ...
                                                <button onclick="execCmd('justifyRight')"><svg
                                                        class="svg-inline--fa fa-align-right" aria-hidden="true"
                                                        focusable="false" data-prefix="fas" data-icon="align-right"
                                                        role="img" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 448 512" data-fa-i2svg="">
                                                        <path fill="currentColor"
                                                ...
                                                <button onclick="execCmd('justifyFull')"><svg
                                                        class="svg-inline--fa fa-align-justify" aria-hidden="true"
                                                        focusable="false" data-prefix="fas" data-icon="align-justify"
                                                        role="img" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 448 512" data-fa-i2svg="">
                                                        <path fill="currentColor"
                                                ...
                                                <button onclick="execCmd('insertUnorderedList')"><svg
                                                        class="svg-inline--fa fa-list-ul" aria-hidden="true"
                                                        focusable="false" data-prefix="fas" data-icon="list-ul"
                                                        role="img" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 512 512" data-fa-i2svg="">
                                                        <path fill="currentColor"
                                                ...
                                                <button onclick="execCmd('insertOrderedList')"><svg
                                                        class="svg-inline--fa fa-list-ol" aria-hidden="true"
                                                        focusable="false" data-prefix="fas" data-icon="list-ol"
                                                        role="img" xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <button
                                                    onclick="execCmd('createLink', prompt('Enter the URL:', 'http://'))"><svg
                                                        class="svg-inline--fa fa-link" aria-hidden="true"
                                                ...
                                                <button onclick="execCmd('unlink')"><svg
                                                        class="svg-inline--fa fa-link-slash" aria-hidden="true"
                                                        focusable="false" data-prefix="fas" data-icon="link-slash"
                                                        role="img" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 640 512" data-fa-i2svg="">
                                                        <path fill="currentColor"
                                                ...
                                                <button onclick="insertImage()"><svg class="svg-inline--fa fa-image"
                                                        aria-hidden="true" focusable="false" data-prefix="fas"
                                                        data-icon="image" role="img"
                                                ...
                                                <button onclick="insertTable()"><svg class="svg-inline--fa fa-table"
                                                        aria-hidden="true" focusable="false" data-prefix="fas"
                                                        data-icon="table" role="img"
                                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                                        data-fa-i2svg="">
                                                        <path fill="currentColor"
                                            ...
                                            <div id="editor" name="mail_content" class="form-control"
                                        ...
                                        <a href="#" style="text-decoration: none; color: rgb(155, 152, 152);"
                                            id="add-file-btn"><span class="mx-1"><svg class="svg-inline--fa fa-plus"
                                                    aria-hidden="true" focusable="false" data-prefix="fas"
                                                ...
                                                </svg><!-- <i class="fa-solid fa-plus"></i> Font Awesome fontawesome.com --></span>Add
                                            an item</a>
                                    </div><!--r-4-->
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <button class="btn btn-primary w-100 mt-3" id="hollabTwoShow"
                                                        onclick="showHollabTwo()"><svg class="svg-inline--fa fa-eye"
                                                            aria-hidden="true" focusable="false" data-prefix="fas"
                                                ...
                                                <div class="col-lg-6">
                                                    <button class="btn btn-success w-100 mt-3"><svg
                                                        ...
                                                        </svg><!-- <i class="fa-solid fa-check"></i> Font Awesome fontawesome.com -->
                                                        Send the email <svg class="svg-inline--fa fa-plus"
                                                            aria-hidden="true" focusable="false" data-prefix="fas"
                                                            data-icon="plus" role="img"
                                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                                            data-fa-i2svg="">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="close-btn-span d-flex justify-content-end me-3">
                                            <a href="email-preview.html" target="_blank"><svg
                                                    class="svg-inline--fa fa-maximize text-primary p-2 bg-light"
                                                    style="
          font-size: 15px;
          cursor: pointer;
        ...
        "></i> Font Awesome fontawesome.com --></a>
                                        ...
                                        <div class="email-send d-flex justify-content-center ">
                                            ...
                                            <div class="col-lg-10 mt-2 mb-2">
                                                <select class="form-select" aria-label="Default select example">
                                                    ...
                                                    <option class="blue-colors-value" value="1">vero Migust&lt;
                                                        veronique.miguest@demossoultions.com&gt;
                                                        (Role:credit Manger)
                                                    </option>
                                                    <option class="blue-colors-value" value="2">vero Migust&lt;
                                                        veronique.miguest@demossoultions.com&gt;
                                                        (Role:credit Manger ) </option>
                                                    <option class="gren-colors-value" value="3">vero Migust&lt;
                                                        veronique.miguest@demossoultions.com&gt;
                                                        (Role:credit Manger ) </option>
                                                    <option class="gren-colors-value" value="4">vero Migust&lt;
                                                        veronique.miguest@demossoultions.com&gt;
                                                        (Role:credit Manger ) </option>
                                                    <option class="gren-colors-value" value="5">vero Migust&lt;
                                                        veronique.miguest@demossoultions.com&gt;
                                                        (Role:credit Manger ) </option>
                                                    <option class="gren-colors-value" value="6">vero Migust&lt;
                                                        veronique.miguest@demossoultions.com&gt;
                                                        (Role:credit Manger ) </option>
                                                    <option class="gren-colors-value" value="7">vero Migust&lt;
                                                        veronique.miguest@demossoultions.com&gt;
                                                        (Role:credit Manger ) </option>
                                                    <option class="gren-colors-value" value="8">vero Migust&lt;
                                                        veronique.miguest@demossoultions.com&gt;
                                                        (Role:credit Manger ) </option>
                                        ...
                                        <div class="email-prev">
                                            ...
                                            Please find below a statement of account showing a total outstanding of:
                                            {{ number_format($items_amount_overdue_exclude_disputes_include_late_penalties, 2) }}..
                                            <br>

                                            We are sure that you simply forgot to send us your payment and we would be
                                            grateful if you could rectify this
                                            ...
                                            <div class="view-button mt-3 mb-3">
                                                <a href="" class="btn btn-success"><span><svg
                                                            class="svg-inline--fa fa-comments" aria-hidden="true"
                                                        ...
                                                        </svg><!-- <i class="fa-solid fa-comments"></i> Font Awesome fontawesome.com --></span>
                                                    View my account
                                                    statement</a>
                                            </div>
                                            <div class="descri">
                                                <p>In anticipation of your payment, we remain at your disposal for any
                                            ...
                                            <div class="the-cloumn  d-flex align-items-center mb-3">
                                                ...
                                                <div class="logo-mail">
                                                    <img src="{{ $my_company_logo }}" class="img-fluid"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="client-code">
                                                ...
                                                <div
                                                    class="client-codes d-flex justify-content-between align-items-center">
                                                    <p><span><svg class="svg-inline--fa fa-star" aria-hidden="true"
                                                            ...
                                                            </svg><!-- <i class="fa-solid fa-star"></i> Font Awesome fontawesome.com --></span>Click
                                                        on the Part Number to see more information and leave a comment::</p>
                                                    <div class="this-buttons">
                                                        <button type="button" class="btn text-light"><span><svg
                                                                ...
                                                                </svg><!-- <i class="fa-solid fa-download"></i> Font Awesome fontawesome.com --> </span>Export
                                                                            ...
                                                                            @if ($due_date->between($startOfMonth, $endOfMonth))
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td
                                                                                        ...
                                                                                        {{ $item->remaining_amount_inc_tax }}
                                                                                        € <img src="img/card.png"
                                                                                            style="width: 17px;"
                                                                                            alt=""
                                                                                            class="img-fluid"></td>
                                                                                    <td></td>
                                                                                    <td>{{ $item->customer_custom_field_2 }}
                                                                                    </td>
                                                                                </tr>
                                                                            @endif
                                                                        @endforeach
                                            ...
                                            <div class="container">
                                                <div class="col-12">
                                                    <button class="mt-3" id="show-items-button"><span
                                                            class="text-black-50"><svg class="svg-inline--fa fa-pen"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                            ...
                                                            </svg><!-- <i class="fa-solid fa-pen"></i> Font Awesome fontawesome.com --></span>
                                                        add an item</button>
                                                    <div class="show-items  d-block bg-light" style="font-size: 6px;">
                                                        <div id="item-contents">
                                                            ...
                                                            <p class=" mb-2" style="font-size: 14px;">(.pdf or .docx or
                                                                .xlsx or .txt or .jpg or .png ...)•Max
                                                                size: 15 MB</p>
                                                            <textarea
                                                                style="width:100%; outline: none; padding: 5px; border: 2px solid #efefef; border-radius: 5px; resize: both;"></textarea>
                                                            <button class=""><svg class="svg-inline--fa fa-plus"
                                                                    aria-hidden="true" focusable="false"
                                        ...
                                        <div class="tw-btn-holab d-flex justify-content-end">
                                            <div class="col-md-8 mt-2">
                                                <div class="row ">
                                                    <div class="col-lg-6">
                                                        <button class="btn btn-primary mt-3 w-100" id="hollabTwoShow"
                                                            onclick="showHollab()"><svg class="svg-inline--fa fa-pen"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="pen" role="img"
                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                                                data-fa-i2svg="">
                                                            ...
                                                            </svg><!-- <i class="fa-solid fa-pen"></i> Font Awesome fontawesome.com -->Modify</button>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <button class="btn btn-success mt-3 w-100"><svg
                                                                class="svg-inline--fa fa-check" aria-hidden="true"
                                                                focusable="false" data-prefix="fas" data-icon="check"
                                                                role="img" xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 448 512" data-fa-i2svg="">
                                                            ...
                                                            </svg><!-- <i class="fa-solid fa-check"></i> Font Awesome fontawesome.com -->send
                                                            the email +
                                                            complete the action</button>
                                                    </div>
                                                </div>
                    ...
                    <div class="new-holap d-none " id="hide-hoalp">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="max-mize">
                                        <a href="email-preview.html" target="_blank" style="border-radius: 50%;"
                                            class="btn btn-primary text-end"><svg class="svg-inline--fa fa-maximize"
                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                data-icon="maximize" role="img" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512" data-fa-i2svg="">
                                                <path fill="currentColor"
                                                    d="M447.1 319.1v135.1c0 13.26-10.75 23.1-23.1 23.1h-135.1c-12.94 0-24.61-7.781-29.56-19.75c-4.906-11.1-2.203-25.72 6.937-34.87l30.06-30.06L224 323.9l-71.43 71.44l30.06 30.06c9.156 9.156 11.91 22.91 6.937 34.87C184.6 472.2 172.9 479.1 160 479.1H24c-13.25 0-23.1-10.74-23.1-23.1v-135.1c0-12.94 7.781-24.61 19.75-29.56C23.72 288.8 27.88 288 32 288c8.312 0 16.5 3.242 22.63 9.367l30.06 30.06l71.44-71.44L84.69 184.6L54.63 214.6c-9.156 9.156-22.91 11.91-34.87 6.937C7.798 216.6 .0013 204.9 .0013 191.1v-135.1c0-13.26 10.75-23.1 23.1-23.1h135.1c12.94 0 24.61 7.781 29.56 19.75C191.2 55.72 191.1 59.87 191.1 63.1c0 8.312-3.237 16.5-9.362 22.63L152.6 116.7l71.44 71.44l71.43-71.44l-30.06-30.06c-9.156-9.156-11.91-22.91-6.937-34.87c4.937-11.95 16.62-19.75 29.56-19.75h135.1c13.26 0 23.1 10.75 23.1 23.1v135.1c0 12.94-7.781 24.61-19.75 29.56c-11.1 4.906-25.72 2.203-34.87-6.937l-30.06-30.06l-71.43 71.43l71.44 71.44l30.06-30.06c9.156-9.156 22.91-11.91 34.87-6.937C440.2 295.4 447.1 307.1 447.1 319.1z">
                                                </path>
                                            </svg><!-- <i class="fa-solid fa-maximize"></i> Font Awesome fontawesome.com --></a>
                                    </div>
                                    <h2 class="text-capitalize text-center mt-3 mb-3">Email preview</h2>
                                    <button class="close-hollab btn btn-danger" onclick="show_popup()"
                                        id="popup"><span><svg class="svg-inline--fa fa-xmark" aria-hidden="true"
                                            ...
                                            </svg><!-- <i class="fa-solid fa-close"></i> Font Awesome fontawesome.com --></span></button>
                                    <div class="emil-para">
                                        <p class="text-capitalize mt-3 mb-3 text-center">This automatic action will be
                                            sent in a few minutes between
                                            8:00 and 19:00</p>
                                    </div>
                                    <div class="email-from d-flex mt-3">
                                        <span class="mx-3">From:</span>
                                        <a href="#">Nicolas Grayson nicolas.durant@demosolutions.com
                                            nicolas.durant&gt;</a>
                                        <span class="mx-3">(Role : Collector)</span>
                                    </div>
                                    ...
                                    <div class="emil-para-2 mt-3 mb-3">
                                        <p class="text-capitalize mt-3 mb-3">Pending invoice(s) Business Solutions - Eros
                                            Proin Ultrices Foundation (B)
                                            - 1040236</p>
                                    </div>
                                    <div class="email-prev">
                                        <p>
                                        ...
                                        <div class="view-button mt-3 mb-3">
                                            <a href="account-statement.html" class="btn btn-success"><span><svg
                                                        class="svg-inline--fa fa-comments" aria-hidden="true"
                                                        focusable="false" data-prefix="fas" data-icon="comments"
                                                        role="img" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 640 512" data-fa-i2svg="">
                                        ...
                                        <div class="client-code">
                                            ...
                                            <div class="client-codes d-flex justify-content-between align-items-center">
                                                <p><span><svg class="svg-inline--fa fa-star" aria-hidden="true"
                                                        ...
                                                        </svg><!-- <i class="fa-solid fa-star"></i> Font Awesome fontawesome.com --></span>
                                                    Click the Trans No. for more information and write a comment:</p>
                                                <div class="this-buttons">
                                                    <button type="button" class="btn text-light"><span><svg
                                                                class="svg-inline--fa fa-download" aria-hidden="true"
                                                                focusable="false" data-prefix="fas"
                                                                data-icon="download" role="img"
                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                                                data-fa-i2svg="">
                                                                <path fill="currentColor"
                                                                    d="M480 352h-133.5l-45.25 45.25C289.2 409.3 273.1 416 256 416s-33.16-6.656-45.25-18.75L165.5 352H32c-17.67 0-32 14.33-32 32v96c0 17.67 14.33 32 32 32h448c17.67 0 32-14.33 32-32v-96C512 366.3 497.7 352 480 352zM432 456c-13.2 0-24-10.8-24-24c0-13.2 10.8-24 24-24s24 10.8 24 24C456 445.2 445.2 456 432 456zM233.4 374.6C239.6 380.9 247.8 384 256 384s16.38-3.125 22.62-9.375l128-128c12.49-12.5 12.49-32.75 0-45.25c-12.5-12.5-32.76-12.5-45.25 0L288 274.8V32c0-17.67-14.33-32-32-32C238.3 0 224 14.33 224 32v242.8L150.6 201.4c-12.49-12.5-32.75-12.5-45.25 0c-12.49 12.5-12.49 32.75 0 45.25L233.4 374.6z">
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tbody class="text-center">
                                                                <tr>
                                                                    ...
                                                                    <td style="display: flex;"><img
                                                                            src="img/pdficons.gif" style="width: 17px;"
                                                                    ...
                                                                    <td
                                                                        style="display: flex; justify-content: space-between;">
                                                                        7,112.64 € <img src="img/card.png"
                                                                            style="width: 17px;" alt=""
                                                                            class="img-fluid"></td>
                                                                    <td></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="7" class="text-end">April 2024 -
                                                                        Total </td>
                                                                    <td>7,112.64 € </td>
                                                                    <td></td>
                                                                </tr>
            ...
            <div class="text-md-start mx-md-5 text-center px-4 mb-2">
                <div class=" thebtn-3 btn  btn-primary text-light px-2 m-1">
                    ...
                    </svg><!-- <i class=" fa-solid fa-check"></i> Font Awesome fontawesome.com -->  Confirm the automatic
                    action
                </div>
                <div class="thebtn-1 position-relative btn btn-primary px-2 m-1" onclick="showCalender()">
                    <svg class="svg-inline--fa fa-calendar" aria-hidden="true" focusable="false" data-prefix="fas"
                    ...
                    </svg><!-- <i class="fa-solid fa-calendar"></i> Font Awesome fontawesome.com --> Update the action
                    date
                            ...
                            <div class="col-md-12">
                                <div class="calendar calendar-first" id="calendar_first">
                                    <div class="calendar_header">
                                        <button class="switch-month switch-left"> <svg
                                        ...
                                        <h2>August 2024</h2>
                                        <button class="switch-month switch-right"> <svg
                                    ...
                                    <div class="calendar_content">
                                        ...
                                        <div class="today" style="color: rgb(0, 189, 170);">7</div>
                                        <div>8</div>
                                        <div>9</div>
                                        <div>10</div>
                                        <div>11</div>
                ...
                <div class=" thebtn-2 btn text-light btn-danger px-2 m-1">
                    ...
                    </svg><!-- <i class="fa-solid fa-trash"></i> Font Awesome fontawesome.com --> Delete
                </div>
            </div>
            ...
            <div class="text-center mb-4">
                <a href="searchForAnItem.html" class="btn btn-primary" style="border-radius: 20px;">Number of open
                    items : 4505</a>
            </div>
            <div class="text-center mb-2">
                <div class="this-buttons">
                    <div class="">
                        <div class="btn-group">
                            <button type="button" class="btn text-light"><span><svg
                                        class="svg-inline--fa fa-download" aria-hidden="true" focusable="false"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="mt-3 "><button type="button" class="btn"
                                        style="width: 100%;"><span><iclass="fa-solid
                                                fa-download"=""> </iclass="fa-solid></span>download</button></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            addDropdownButton.addEventListener('click', () => {
                ...
                const createDropdown2 = () => {
                    ...
                    count; // Make sure this aligns with your expected input names
                    @foreach ($combined as $item)
                        ...
                        @elseif ($item instanceof \App\Models\User) {
                                ...
                                option.value = email;
                                option.textContent = firstName + ' <' + email + '> (Function: ' +
                                    functionName + ' / Role: ' + roleName + ') *** ' + roleName +
                                    ' ***';
                                select.appendChild(option);
                            }
                        @endif
