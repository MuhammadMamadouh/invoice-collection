<div class="col-lg-3 col-md-4 col-sm-6">
    <a href="collectionManualActions.html" class="m-1 w-100 btn btn-secondary  p-3">
        <i class="fa-solid fa-hand-point-right"></i> Manual actions
        <span class="badge bg-danger">{{$manualActionsCount}}</span>
    </a>
</div>
<div class="col-lg-3 col-md-4 col-sm-6">
    <a href="collection.html" class="m-1 w-100 btn btn-outline-secondary text-dark p-3"><i
...
<!--btns-->
<div class="col-lg-3 col-md-4 col-sm-6">
    <a href="collectionActionsHistoy.html" class="m-1 w-100 btn btn-outline-secondary text-dark p-3"><i
