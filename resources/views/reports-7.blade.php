...
<div class="header-risk">
  <h2 class="text-capitalize text-center mt-5 mb-2">Report overdue trend  <i class="fa-solid fa-question bg-primary text-light p-1" style="border-radius: 50%;width: 22px;height: 22px;"></i></h2>
</div>
<div class="title-risk text-capitalize">
  <div class="container d-flex justify-content-between">
    <div>
      <h4 class="mt-1 text-capitalize border-primary"><span><i class="fa-solid fa-clock-rotate-left"></i></span>Overdue trend</h4>
    </div>
</div>
...
<div class="texts text-capitalize">
  <div class="container-fluid">
    <div class="responive-report-5">
      ...
      <div
        class="text-center mb-3 p-2 p-md-4" style="background-color: #006bff14">
...
<!--texts-->
   ...
   <script src="js/chart-7.js"></script>
