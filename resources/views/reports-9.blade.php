...
<div class="header-risk">
  <h2 class="text-capitalize text-center mt-5 mb-2">Report DSO  <a href="DSOInformation.html"><i class="fa-solid fa-question bg-primary text-light p-1" style="border-radius: 50%;width: 22px;height: 22px;"></i></a></h2>
</div>
<div class="title-risk text-capitalize">
  <div class="container d-flex justify-content-between">
    <div>
      <h4 class="mt-1 text-capitalize border-primary"><span><i class="fa-solid fa-chart-line"></i></span>DSO trend </h4>
    </div>
</div>
<hr class="container">
</div>
    ...
    <div class="responive-report-5">
      ...
      <div class="row mt-2 px-4 align-items-center text-center">
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">current DSO</p>
              </div>
        </div>
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">overdue DSO</p>
              </div>
        </div>
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">cost of a day of DSO</p>
              </div>
        ...
        <div class="col hide">
          <div class="d-flex align-items-center justify-content-center gap-1 ">
                <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                <p class="fw-bold">Equivalent of a day of DSO</p>
              </div>
