...
<body class="cairo-uniquifier position-relative">
                ...
                <form class="d-flex flex-column align-items-start mb-3" method="post"
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="inputname18" name="name"
                                value="{{old('name')}}">
                        </div>
                        @error('name')
    ...
    <!-- Update form -->
    <div class="position-fixed edit-group-div d-none"
        style="top:10%; left: 50%; transform: translate(-50%); z-index: 10;">
        <div class="bg-white m-auto p-3 shadow-sm position-relative" style="border-radius: 10px;">
                ...
                <form id="editGroupForm" class="d-flex flex-column" method="post">
                    ...
                    <div class="d-flex gap-3">
                        <div class="flex-grow-1">
                            <label>{{_("Clients:")}}</label>
                            <textarea id="editClients" class="form-control" cols="30" rows="10"
                        ...
                        <div class="flex-grow-1">
                            <label>{{_("Associated with the group:")}}</label>
                            <textarea id="editAssociated" class="form-control" cols="30" rows="10"
                                name="associated"></textarea>
                        </div>
                    </div>
                    <div class="text-center mt-3">
                    ...
                    <ul class="navbar-nav ms-auto text-center mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('clients.index')}}"><span><i
                                        class="fa-solid fa-globe"></i></span>clients</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="settingsDropdown">
                                ...
                                <li><a class="dropdown-item text-primary"
                                        href="settings-manage-collection-scenario.html"><i
                ...
                <div class="form-group d-flex align-items-center">
                    ...
                    <form action="{{ route('clients-group.store') }}" method="POST">
                        <select name="per_page" class="form-select w-auto m-2" onchange="this.form.submit()">
                            ...
                            <option value="{{ $clientsGroups->total() }}" {{ request('per_page')==$clientsGroups->
                                total() ? 'selected' : '' }}>{{ $clientsGroups->total() }}</option>
                        </select>
                    </form>
                    ...
                    <tr class="kall">
                        ...
                        <td class="border-0">
                            <p class="operate name-d ">
                                ...
                                <a href="get-client-group/{{ $clientsGroup->id}}"
                                    onclick="showEditGroupDiv({{ $clientsGroup->id }})"
                                    class="text-decoration-none edite-groups rounded">
                                    <i class="fa-solid fa-pen"></i>

                                    <a href="delete-client-group/{{ $clientsGroup->id}}"
                                        class="text-decoration-none delete-groups rounded"
                                        onclick="return confirm('Are you sure you want to delete this client group?')"><i
