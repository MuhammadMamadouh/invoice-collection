...
<!--new-Holap-->
    ...
    <section class="my-sear my-2 container-fluid">
        <div class="s-c-notation  my-5" style="border-bottom:solid 1px #6b6565">
          <div class="row gajj text-center ">
            ...
            <div class="col-md-5 my-3">
              <a href="#" class="text-primary text-decoration-none  b-btm " style="color: #6b6565;"><i class="fa-solid fa-search px-1"></i>search for an item(invoice,credit note,...)</a>
            </div>
      ...
      <section class="m-groups my-5">
        <div class="container-fluid">
         <a href="#" class="dab d-flex justify-content-end align-items-center" onclick="showAdvancedSearch()" ><i class="fa-solid fa-gear mx-2"></i>Advanced Setting<i class="fa-solid fa-arrow-right mx-2"></i></a>
         <div class="create-c-i my-5">
            <div class="row">
              <div class="col-md-6  my-2">
                  <form class="d-flex">
                    <div class="col-5 ">
                      <label for="inputname0">Item type My DSO Manager:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                    <div class="col-5 ">
                      <label for="inputname1">Item type:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                    <div class="col-5 ">
                      <label for="inputname5">Trans No.:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                      <div class="col-3 col-md-5 ">
                          <label for="inputname8">Overdue (No. of days):</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                    <div class="col-5 ">
                      <label for="inputname9">PO No.:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                      <div class="col-4 col-md-5 ">
                          <label for="inputname10">Payment date:
                          </label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                      <div class="col-4 col-md-5 ">
                          <label for="inputname12">Currency:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                    <div class="col-5 ">
                      <label for="inputname13">ERP item type:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                      <div class="col-4 col-md-5 ">
                          <label for="inputname14">Initial amount exc. Tax:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                      <div class="col-4 col-md-5 ">
                          <label for="inputname16">Initial amount inc. Tax:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                    <div class="col-5 ">
                      <label for="inputname17"> Sales manager:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                      <div class="col-4 col-md-5 ">
                          <label for="inputname18">Remaining amount exc. Tax:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                    <div class="col-5 ">
                      <label for="inputname19">Sales administrative:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                      <div class="col-4 col-md-5 ">
                          <label for="inputname20">Remaining amount inc. Tax:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                    <div class="col-5 ">
                      <label for="inputname21">Cleared?</label>
        
                    </div>
                    <div class="col-7 ">
                      <select class="form-select" id="inputname21">
                          <option value="" selected disabled>YES</option>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                    <div class="col-5 ">
                      <label for="inputname22">Type of status:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                    <div class="col-5 ">
                      <label for="inputname23">Resolver:</label>
        
                    </div>
                    <div class="col-7 ">
                      <input type="text" class="form-control" id="inputname23">
                    </div>
                  </form>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                      <div class="col-4 col-md-5 ">
                          <label for="inputname24">Status:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                    <div class="col-5 ">
                      <label for="inputname25">Custom field #1:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                      <div class="col-4 col-md-5 ">
                          <label for="inputname26">Status date:</label>
                        ...
                        <div class="col-md-7 col-8">
                          <div class="input-group ">
                              <span class="input-group-text">between</span>
                              <input type="text" class="form-control " id="inputname26">
                              <span class="input-group-text ">&</span>
                              <input type="text" class="form-control " id="inputname26">
                              <span class="input-group-text"><i class="fa-solid fa-calendar-days"></i></span>
                            </div>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                    <div class="col-5 ">
                      <label for="inputname27">Custom field #2:</label>
                ...
                <div class="col-md-6 my-2">
                  <form class="d-flex">
                      <div class="col-4 col-md-5 ">
                          <label for="inputname26">Date of promise of payment:</label>
            ...
            <div class="container text-center mt-3">
              <button  onclick="document.querySelector('.search-results').classList.remove('d-none')" class="btn btn-primary btn-lg" ><i class="fa-solid fa-search"></i> Search</button>
            </div>
          </div><!--create-c-i-->
        </div><!--container-->
                  ...
                  <div class="container-fluid">
                    <div class="row table-alerts-container">
                      <div class="col-12">
                        ...
                        <div class="big-table">
                          <div class="big-table-child" style="width: 2000px !important; ">
                            <div class="row mt-2 align-items-center px-md-4 text-center">
                              ...
                              <div class="col ">
                                <div class="d-flex align-items-center justify-content-center gap-1 ">
                                  <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                                  <p class="fw-bold">Intial amount exc. Tax</p>
                                </div>
                              </div>
                              <div class="col ">
                                <div class="d-flex align-items-center justify-content-center gap-1 ">
                              ...
                              <div class="col">
                                <div class="d-flex align-items-center justify-content-center gap-1 ">
                                  <i class="fa-solid fa-sort mb-3" style="cursor:pointer"></i>
                                  <p class="fw-bold">Remaining amount exc. Tax</p>
                                </div>
                              </div>
                              <div class="col">
                                <div class="d-flex align-items-center justify-content-center gap-1 ">
                            ...
                            <div
                              ...
                              <div class="row align-items-center px-md-4" style="background-color: #006bff14">
                                ...
                                <div class="col mb-3 position-relative">
                                    <a href="#" onclick="showHolap()">1110081</a>
                                </div>
                                <div class="col"><a href="#" onclick="showHolap()">Linkedin Technology</a></div>
                                <div class="col">
                                  <p class="fw-bold"><a href="#" onclick="showInvoice()"><img src="./img/pdficons.gif" class="mb-1" alt=""> 2401356</a></p>    
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                  <p class="fw-bold"><a href="#" onclick="showInvoice()">11,187.32 €</a></p>
                                </div>
                                <div class="col">
                                  <p class="fw-bold"><a href="#" onclick="showInvoice()">11,187.32 €</a></p>
                                </div>
                        ...
                        <div class="row px-4 align-items-center m-0 mb-2">
                          <div class="col-lg-2 col-sm-3 col-6 mb-2">
                            <div class="btn text-light btn-primary px-2" onclick="associateFiles()">
                              <i class="fa-solid fa-link"></i>&ensp;Associate File
                            </div>
                          ...
                          <div class="col-lg-2 col-sm-3 col-6 mb-2">
                            <select class="form-select bg-light" aria-label="Default select example">
                              ...
                              <option value="1">Downpayment request</option>
                              <option value="2">Invoice</option>
                              <option value="2">Miscellaneous transaction</option>
